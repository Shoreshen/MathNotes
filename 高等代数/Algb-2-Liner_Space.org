...
（5） $\forall\vec{a}\in V\Rightarrow 1 \vec{a}=\vec{a}$ 其中 $1$ 为[[~/文档/note/抽象代数/cxds.org::MK338][域]] $K$ 的乘法[[~/文档/note/离散数学/lssx.org::MK299][幺元]]
...
若线性空间 $\mathcal{V}=\left<V,K,+,\cdot\right>,\mathcal{V}'=\left<V',K,\bar{+},\bar{\cdot}\right>$ 存在[[~/文档/note/离散数学/lssx.org::MK181][双射函数]] $\sigma:V\rightarrow V'$ 且满足：
...
即 $B$ 是 $\mathcal{V}'$ 的[[MK36][基]]，则根据[[MK121][维数]]与[[MK138][基]]可得 $B$ 是 $\mathcal{V}$ 的[[MK138][基]]且 $\dim(\mathcal{V})=n$
