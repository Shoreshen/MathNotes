...
若 $n=\dim(\mathcal{V})$ 则存在 $a\in V$ 使得 $\{\sigma^{n-1}(a),\sigma^{n-2}(a),...,a\}$ 是 $\mathcal{V}$ 的[[~/文档/note/高等代数/Algb-2-Liner_Space.org::MK36][基]]
...
根据[[MK123][性质3]]可得存在 $a$ 使得 $A=\{a,\sigma(a),\sigma^2(a),...,\sigma^{n-1}(a)\}$ [[~/文档/note/高等代数/Algb-2-Liner_Space.org::MK8][线性无关]]，又根据 $n=\dim(\mathcal{V})$ 以及[[~/文档/note/高等代数/Algb-2-Liner_Space.org::MK42][命题2]]

可得 $A$ 是 $\mathcal{V}$ 的[[~/文档/note/高等代数/Algb-2-Liner_Space.org::MK36][基]]，则有
