...
根据[[~/文档/note/离散数学/Disc_Math.org][性质]]中德摩根率可得 $\bigcap_{i=1}^\infty S_i=((\bigcap_{i=1}^\infty S_i)^c)^c=\left(\bigcup_{i=1}^\infty S_i^c\right)^c$
...
则根据可测集定义，[[MK61][次可加性]]以及[[~/文档/note/离散数学/Disc_Math.org][性质]]中分配率、结合律、补与减有：
...
加法幺元 $0$ 是乘法[[~/文档/note/离散数学/Disc_Math.org::MK313][零元]]
...
根据[[~/文档/note/离散数学/Disc_Math.org::MK316][性质2]]可得逆元唯一，故有 $(-1)\cdot a=a$
...
由于加法满足结合律，故根据[[~/文档/note/离散数学/Disc_Math.org][性质3]]可得 $a,b$ 逆元的逆元均为 $a,b$ 本身 

由于 $a,b$ 的逆元均为 $-b$ 根据[[~/文档/note/离散数学/Disc_Math.org::MK316][性质2]]可得 $-b$ 的逆元唯一，故有 $a=b$
...
由于加法是[[~/文档/note/离散数学/Disc_Math.org][运算]]故满足单值性，则有 $a-b+b-c=0+0$
...
（1） $a=b$ 根据[[~/文档/note/离散数学/Disc_Math.org][运算]]单值性有 $a+c=b+c$
...
根据的[[~/文档/note/离散数学/Disc_Math.org][集合族运算与交并]]可得 $\bigcup_{i=1}^\infty(E\cap V_i)=E\cap\bigcup_{i=1}^\infty V_i$
