...
根据[[~/文档/note/离散数学/Disc_Math.org::MK20][包含]]可得 $\underline{\lim_{n\to\infty}}A_n\subset\overline{\lim_{n\to\infty}}A_n$ 
...
则根据[[~/文档/note/离散数学/Disc_Math.org::MK21][定理1]]可得 $\cup_{i\geq 1}\left(\cap_{k\geq i}A_k\right)=\cap_{i\geq 1}\left(\cup_{k\geq i}A_k\right)$ 
...
则有 $a\in\cup_{i\geq 1}\left(\cap_{k\geq i}A_k\right)$ ，根据[[~/文档/note/离散数学/Disc_Math.org::MK20][包含]]可得 $\cap_{i\geq 1}\left(\cup_{k\geq i}A_k\right)\subset\cup_{i\geq 1}\left(\cap_{k\geq i}A_k\right)$ 
...
根据[[~/文档/note/离散数学/Disc_Math.org::MK20][包含]]可得 $\cap_{i\geq 1}\left(\cup_{k\geq i}A_k\right)\subset\cup_{i\geq 1}\left(\cap_{k\geq i}A_k\right)$ 
...
定义[[~/文档/note/抽象代数/cxds.org::MK298][代数结构]] $<X,d>$ 运算 $d:X\times X\to\mathbb{R}$ 满足：
...
根据[[~/文档/note/离散数学/Disc_Math.org::MK328][德摩根率]]可得 $\bigcap_{i=1}^\infty S_i=((\bigcap_{i=1}^\infty S_i)^c)^c=\left(\bigcup_{i=1}^\infty S_i^c\right)^c$
...
根据[[MK70][定理]]可得 $\lim_{n\to\infty}S_n=\bigcap_{i=1}^\infty S_i$ 且 $\forall i\in\mathbb{N}^+\rightarrow S\in\sigma(X)$ 则根据[[MK70][定理（4）]]有 $\bigcap_{i=1}^\infty S_i\in\sigma(X)$
...
根据[[~/文档/note/离散数学/Disc_Math.org::MK194][函数定义]]可得对于任意 $x\in E$ 均有 $y\in K$ 满足 $f(x)=y$
...
则对于任意 $x\in g\left(\bigcup_{i=1}^\infty X_i\right)$ 根据[[~/文档/note/离散数学/Disc_Math.org::MK329][运算]]可得 $f(x)\in\bigcup_{i=1}^\infty X_i\leftrightarrow\exists i\in\mathbb{N}\rightarrow f(x)\in X_i$
...
故根据[[~/文档/note/离散数学/Disc_Math.org::MK5][外延公理]]可得 $g\left(\bigcup_{i=1}^\infty X_i\right)=\bigcup_{i=1}^\infty g(X_i)$
...
故根据[[~/文档/note/离散数学/Disc_Math.org::MK5][外延公理]]可得 $\left(g(X)\right)^c=g(X^c)$
...
（2）[[~/文档/note/数理逻辑/sllj.org::MK186][德摩根律]]

（3）[[~/文档/note/数理逻辑/sllj.org::MK452][分配率]]
...
根据[[~/文档/note/离散数学/Disc_Math.org::MK380][逻辑等价式举例]]-分配率有 $Y\cap\left(\bigcup_{i=1}^\infty A_i\right)\in\sigma_{\Psi}(Y)$
...
定义 $\mathcal{B}(X)$ 为 $X$ 上的[[MK153][borel集]]，则定义 $X$ 上所有闭集（开集的补集）为 $\mathcal{C}$
...
同理可证 $\sigma_{\mathcal{C}}(X)\subset\mathcal{B}(X)$ 故根据[[~/文档/note/离散数学/Disc_Math.org::MK21][自反性]]可得 $\sigma_{\mathcal{C}}(X)=\mathcal{B}(X)$ 

**** 连续映射原相一致<<MK117>>

定义 $\mathcal{B}(X)$ 为 $X$ 上的[[MK153][borel集]]，$\mathcal{B}(Y)$ 为 $Y$ 上的[[MK115][borel集]]，且 $<X,T_X>,<Y,T_Y>$ 均为[[MK39][拓扑空间]]
...
定义 $<Y,\varphi>$ 是 $<X,\varphi>$ 上的[[MK208][外侧度子空间]]
...
则根据可测集定义，[[MK61][次可加性]]以及[[MK327][分配率]]、[[MK40][结合律]]、[[MK334][补与减]]有：
...
对每一个构成区间任取一个有理数，则构成[[~/文档/note/离散数学/Disc_Math.org::MK195][单射]]

进一步根据[[~/文档/note/离散数学/Disc_Math.org::MK3][基数]]可得 $|T|\leq|\mathbb{Q}|$ 
...
对于任意闭集 $K\in\mathbb{R}$ 根据[[~/文档/note/数学分析/Chap11Note.org::P1][定理1]]可得其补集 $K^c$ 是开集
...
则根据[[~/文档/note/离散数学/Disc_Math.org::MK499][定理2]]可得 $H_0$ 是可数集
...
由于 $\Gamma_k\subset H_k$ 且 $H_k$ 可数，则根据[[~/文档/note/离散数学/Disc_Math.org::MK47][无限集]]可得 $\Gamma_k$ 至多可数

则根据[[~/文档/note/离散数学/Disc_Math.org::MK49][定理1]]可得 $\bigcup_{i=0}^\infty\Gamma_i$ 亦为至多可数

且根据构造，每个 $J\in\bigcup_{i=0}^\infty\Gamma_i$ 是区间，且两两互不相交 

**** 证明结论

根据[[~/文档/note/数学分析/Chap11Note.org::MK32][开集]]定义，对于任意 $x\in G$ 均存在 $\delta\in\mathbb{R}\land\delta>0$ 满足 $O(x,\delta)\subset G$ 
...
综上所述根据[[~/文档/note/离散数学/Disc_Math.org::MK5][外延公理]]可得 $G=\bigcup_{i=0}^\infty\left(\bigcup_{J\in\Gamma_i}J\right)$
...
对于任意 $\{a,b\}\subset\mathbb{R}$ 有二元[[~/文档/note/抽象代数/cxds.org::MK292][运算]] $a+b$ 与 $a\cdot b$ 定义为加法，乘法，满足：
...
（4） 存在加/乘法[[~/文档/note/抽象代数/cxds.org::MK299][幺元]]： $\exists 0\in\mathbb{R}\forall a\in\mathbb{R}\left(0+a=a\right)\land\exists1\in\mathbb{R}\forall a\in\mathbb{R}\left(1\cdot a=a\right)$

（5） 存在加/乘法[[~/文档/note/抽象代数/cxds.org::MK302][逆元]]： $\forall a\in\mathbb{R}\rightarrow\exists (-a)\in\mathbb{R}\left(-a+a=0\right)\land\forall (a\in\mathbb{R}\land a\ne0)\rightarrow\exists a^{-1}\in\mathbb{R}\left(a^{-1}\cdot a=1\right)$
...
即 $-0=0$ 因为 $0+0=0$ 且根据[[~/文档/note/抽象代数/cxds.org::MK304][性质2]]可得逆元唯一
...
加法幺元 $0$ 是乘法[[~/文档/note/抽象代数/cxds.org::MK301][零元]]
...
根据[[~/文档/note/抽象代数/cxds.org::MK304][性质2]]可得逆元唯一，故有 $(-1)\cdot a=a$
...
则 $(-b)$ 是 $a$ 的[[~/文档/note/抽象代数/cxds.org::MK302][逆元]]，且有 $-b$ 亦定义为 $b$ 的逆元

由于加法满足结合律，故根据[[~/文档/note/抽象代数/cxds.org::MK533][性质3]]可得 $a,b$ 逆元的逆元均为 $a,b$ 本身 

由于 $a,b$ 的逆元均为 $-b$ 根据[[~/文档/note/抽象代数/cxds.org::MK304][性质2]]可得 $-b$ 的逆元唯一，故有 $a=b$

**** 相等是等价关系<<MK11>>

根据法[[~/文档/note/离散数学/Disc_Math.org::MK176][等价关系]]若 $\{a,b\}\subset\mathbb{R}$ 则 $a=b$ 满足自反性，对称性以及传递性
...
由于加法是[[~/文档/note/抽象代数/cxds.org::MK293][运算]]故满足单值性，则有 $a-b+b-c=0+0$
...
对于任意 $\{a,b,c\}\subset\mathbb{R}$ 存在[[~/文档/note/离散数学/Disc_Math.org::MK155][二元关系]] $>$ 满足：
...
定义[[~/文档/note/离散数学/Disc_Math.org::MK155][二元关系]] $\geq$ 为 $a\geq b{|\!\!\!=\!\!\!|}a>b\lor a=b$
...
（1） $a=b$ 根据[[~/文档/note/抽象代数/cxds.org::MK293][运算]]单值性有 $a+c=b+c$
...
由于 $c<0$ 则根据[[MK4][域公理5]]可得存在[[~/文档/note/抽象代数/cxds.org::MK302][逆元]] $c'$ 且根据[[MK17][逆元等价]]可得 $(-1)c'=c$
...
由于 $-1$ 是 $1$ 的加法[[~/文档/note/抽象代数/cxds.org::MK302][逆元]]，进一步根据[[MK17][逆元等价]]可得 $(-1)(-1)=1$

且 $1$ 是乘法[[~/文档/note/抽象代数/cxds.org::MK299][幺元]]，故有 $bc>ac$
...
根据[[MK14][大于等于]]传递性有 $a\leq x\leq b$ 故根据[[~/文档/note/离散数学/Disc_Math.org::MK20][包含]]可得 $\left[a,\frac{a+b}{2}\right]\subset[a,b]$
...
根据[[~/文档/note/数理逻辑/sllj.org::MK186][德摩根律]]可得等价命题 $\forall i\in I\rightarrow (a<i\lor a\geq i+1)$
...
根据[[~/文档/note/数学分析/Chap11Note.org::MK11][开覆盖]]的定义

故任意 $U\in H$ 是满足[[~/文档/note/数学分析/Chap11Note.org::MK10][开集定义]]的集合
...
其中 $C$ 是一个满足[[~/文档/note/数学分析/Chap11Note.org::MK10][开集定义]]的开集

则根据开集定义可知 $\xi$ 是[[~/文档/note/数学分析/Chap11Note.org::MK32][内点]]，故 $\exists\epsilon>0\rightarrow (\xi-\epsilon,\xi+\epsilon)\subset C$
...
根据[[~/文档/note/数学分析/Chap11Note.org::JDCYTJ1][充要条件1]]
...
显然 $\{na\}\sim\mathbb{N}$ 即为可数集，根据[[~/文档/note/离散数学/Disc_Math.org::MK44][可数集]]可知 $\{na\}$ 是无限集
...
定义 $\{x_n\}$ 是满足 $\forall \epsilon>0,\exists N,\forall n,m>N\Rightarrow |x_n-x_m|<\epsilon$ 的[[~/文档/note/离散数学/Disc_Math.org::MK44][可数集]]
...
定义区间 $(a,b)\subset\mathbb{R}$ 显然函数 $\tan(x)$ 是[[~/文档/note/离散数学/Disc_Math.org::MK200][双射]]函数
...
则根据[[~/文档/note/离散数学/Disc_Math.org::MK4][伯恩斯坦定理]]可得 $|[a,b]|=|\mathbb{R}|$
...
根据[[MK36][定理0]]可得 $\mathbb{R}\sim(0,1)$ 假设 $(0,1)$ 区间与 $\mathbb{N}^+$ [[~/文档/note/离散数学/Disc_Math.org::MK27][对等]]，则存在双射函数 $\sigma$
...
即 $a$ 不在数列中，则不存在 $\sigma(a)$ 故不满足[[~/文档/note/离散数学/Disc_Math.org::MK194][函数定义]]与 $\sigma$ 是双射函数矛盾

即假设不成立 $(0,1)$ 不可数，根据[[~/文档/note/离散数学/Disc_Math.org::MK28][定理]]其为等价关系。
...
（1） 任意 $A_n\land n\in N$ 均与 $\mathbb{R}$ [[~/文档/note/离散数学/Disc_Math.org::MK27][对等]]

（2） 任意 $\{n,m\}\subset N$ 均有 $A_n\cap A_m=\varnothing$

（2） $N$ 是[[~/文档/note/离散数学/Disc_Math.org::MK48][至多可数集]]
...
（1） 任意 $A_n\land n\in N$ 均与 $\mathbb{R}$ [[~/文档/note/离散数学/Disc_Math.org::MK27][等势]]

（2） $N$ 是[[~/文档/note/离散数学/Disc_Math.org::MK48][至多可数集]]

则其笛卡尔积 $\prod_{n\in N}A_n$ 亦与 $\mathbb{R}$ [[~/文档/note/离散数学/Disc_Math.org::MK27][等势]]

***** 证明

根据[[~/文档/note/离散数学/Disc_Math.org::MK616][定理3]]可得 $\left|\prod_{n\in N}A_n\right|=|\mathbb{R}|$

**** 推论3

定义 $A_i=\{0,1,...,K\}$ 是[[~/文档/note/离散数学/Disc_Math.org::MK42][有限集]]，则有 $\left|\prod_{i=1}^K A_i\right|=|\mathbb{R}|$

***** 证明

根据[[~/文档/note/离散数学/Disc_Math.org::MK618][定理5]]易证 $\left|\prod_{n\in N}A_n\right|=|\mathbb{R}|$ 

**** 推论4

根据[[MK37][推论2]]， $n$ 维[[~/文档/note/数学分析/Chap11Note.org::MK37][欧式空间]] $\mathbb{R}^n$ 亦与 $\mathbb{R}$ 对等
...
根据[[~/文档/note/离散数学/Disc_Math.org::MK23][定理4]]可得对于任意 $\epsilon>0\land\epsilon\in\mathbb{R}$ 均有 $\varnothing\subset I$
...
故 $\left\{\sum_{i=1}^\infty |I_i|\big|E\subset\bigcup_{i=1}^\infty I_i\right\}$ 有下界，根据[[~/文档/note/数学分析/Chap11Note.org::MK9][确界存在定理]]必有下确界
...
定义 $I_i=\prod_{j=1}^n[a_{i,j},b_{i,j}]$ 此处乘法为[[~/文档/note/离散数学/Disc_Math.org::MK153][直积]]
...
由于 $<\mathbb{R},\mathcal{O}>$ 是[[MK39][拓扑空间]]，故根据[[MK130][子空间]]可得 $<(0,1),\mathcal{M}>$ 是其子拓扑空间
...
故根据下确界定义，存在[[~/文档/note/数学分析/Chap11Note.org::MK32][开集]] $G$ 使得 $K\subset G\land m^*(G)<2m^*(K)$

取 $G$ 的补集 $G^c$ 根据[[~/文档/note/数学分析/Chap11Note.org::P1][定理1]]可得 $G^c$ 为闭集且 $G^c\cap K=\varnothing$

***** 证明距离大于零

定义 $d(G^c,K)$ 为集合间的[[MK89][度量]]，此时若 $d(G^c,K)=0$ 则必然存在 $\vec{x}$ 满足 $\forall\delta>0,\exists\vec{y}\in G^c\rightarrow y\in O(\vec{x},\delta)$

根据[[~/文档/note/数学分析/Chap11Note.org::JDCYTJ1][充要条件1]]可得 $\vec{x}$ 是 $G^c$ 的聚点，结合闭集定义可得 $\vec{x}\in G^c$
...
定义[[~/文档/note/离散数学/Disc_Math.org::MK155][二元关系]] $R=\left\{<x,y>\big|x\in\mathbb{R}\land y\in\mathbb{R}\land x-y\in\mathbb{Q}\right\}$ 即两个相差有理数的实数，显然有：
...
定义集合 $V$ 为从每个上述划分中选取一个代表元素，根据[[~/文档/note/离散数学/Disc_Math.org::MK10][选择公理]]可得 $V$ 存在

根据[[~/文档/note/离散数学/Disc_Math.org::MK325][推论]]可得有理数是可数集
...
由于 $R$ 可形成 $\mathbb{R}$ 上的[[~/文档/note/离散数学/Disc_Math.org::MK179][划分]]，故对于任意 $x\in\mathbb{R}$ 均有一个划分与其对应

根据 $V$ 的定义存在 $y\in V\rightarrow y\in[x]_R$ 且必然 $x-y\in\mathbb{Q}$ 根据有利数可列性有 $x-y=q_k$ 继而有 $x\in V_k$

故有 $\mathbb{R}\subset\bigcup_{i=1}^\infty V_i$ 又由于显然 $\mathbb{R}\supset\bigcup_{i=1}^\infty V_i$ 则根据[[~/文档/note/离散数学/Disc_Math.org::MK21][定理1]]可得 $\mathbb{R}=\bigcup_{i=1}^\infty V_i$

由于 $E\subset\mathbb{R}$ 故有 $E\cap \bigcup_{i=1}^\infty V_i=E$ 

根据的[[~/文档/note/离散数学/Disc_Math.org::MK741][集合族运算与交并]]可得 $\bigcup_{i=1}^\infty(E\cap V_i)=E\cap\bigcup_{i=1}^\infty V_i$
...
故定义集合 $V$ 为从每个上述划分中选取一个 $[0,1]$ 中的代表元素，根据[[~/文档/note/离散数学/Disc_Math.org::MK10][选择公理]]可得 $V$ 存在

取 $[-1,1]$ 中所有的有理数，根据[[~/文档/note/离散数学/Disc_Math.org::MK325][推论]]可得有理数是可数集

进一步根据[[MK43][稠密性]]可得 $[-1,1]$ 中所有有理数的集合为[[~/文档/note/离散数学/Disc_Math.org::MK43][无限集]]
...
故有 $\forall x\in[0,1]\rightarrow x\in V_u\subset\bigcup_{i=1}^\infty V_k$ 则根据[[~/文档/note/离散数学/Disc_Math.org::MK20][子集]]可得 $[0,1]\subset\bigcup_{k=1}^\infty V_k$
...
故根据[[~/文档/note/离散数学/Disc_Math.org::MK20][子集]]定义可得 $O(\vec{x}_0,\delta)\subset\left\{\vec{x}\big|\left|f(\vec{x})-f(\vec{x}_0)\right|<\epsilon\right\}$
...
易证 $[a,x_0]-E_{x_0}\subset [a,b]-E\land \varphi([a,b]-E)=0$ 根据[[MK128][子集零测]]可得 $\varphi([a,x_0]-E_{x_0})=0$
...
根据[[MK161][定理2]]可得 $f_2(x)$ 可测，则根据[[MK172][确界运算]]可得 $\sup(A(x))$ 可测，即[[MK99][正部]]可测
...
进一步根据[[MK99][正负部定义]]有 $f(x)=f^+(x)-f^-(x)$
...
根据条件有 $f(x)$ 在 $E-E'$ 上连续，则定义 $<E-E',\varphi>$ 是 $<E,\varphi>$ 的[[MK208][外侧度子空间]]
...
故根据[[MK82][区间可测]]得对于任意 $a\in\mathbb{R}_e$ 其原相可测，即函数[[MK134][可测]]
...
且根据[[MK204][之前证明]]可得 $\phi_i(x)$ 在 $<F,\tau(F)>$ 上[[MK106][连续]]，同理有 $\phi'_i(x)$ 在 $<F,\tau(F)>$ 上[[MK106][连续]]
...
又根据[[~/文档/note/离散数学/Disc_Math.org::MK326][确界定义]]易证 $$\int_E f(x)\chi_{A}(x)dx=\sup\left\{\int_E\phi(x)dx\bigg|\phi(x)\in\mathcal{Z}_E(f(x)\chi_{A}(x))\right\}\leq\int_A g(x)dx$$
...
根据[[MK233][性质4]]可得 $$\int_{E_0}f(x)dx=0$$ 故有 $$\int_Ef(x)dx =\int_{E'}f(x)dx$$
...
故根据[[~/文档/note/离散数学/Disc_Math.org::MK326][确界定义]]易证 $$\int_{A\cup B}f(x)dx=\sup\left\{\int_E\phi(x)\bigg|\phi(x)\in\mathcal{Z}_{A\cup B}(f(x))\right\}\leq\int_Af(x)dx+\int_Bf(x)dx$$
...
进一步根据[[MK82][区间可测]]以及[[MK65][Caratheodory定理]]可得 $\varphi\left(\bigcup_{i=1}^\infty I_i\right)=\sum_{i=1}^\infty \varphi(I_i)<\infty$ 即证明（3）
...
根据[[MK82][区间可测]]、[[MK65][Caratheodory定理]]以及[[MK322][之前证明]]可得 $\varphi\left(\bigcup_{i=k}^\infty J_i\right)=\sum_{i=k}^\infty\varphi(J_i)=5\sum_{i=k}^\infty\varphi(I_i)$
