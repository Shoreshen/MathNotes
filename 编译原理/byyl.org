...
定义四元[[~/文档/note/抽象代数/cxds.org::MK298][代数结构]] $G=<V_N,V_T,P,s>$ 为语法，定义 $V=V_T\cup V_N$ 表示文法[[MK1][符号集]]
...
定义[[~/文档/note/高等代数/Algb-3-Matrix.org::MK6][矩阵的表述]] $M_{|S|\times|\Sigma|}[a_{sa}]$ 其中 $s\in S\land a\in\Sigma$ 
...
对于[[MK103][算符优先文法]] $G=<V_N,V_T,P,s>$ 定义[[~/文档/note/高等代数/Algb-3-Matrix.org::MK6][矩阵的表述]] $M_{|V_T|\times|V_T|}[a_{ij}]$
...
根据[[MK93][定理1]]可得 $D_1,D_2$ 有[[MK92][句柄]] $\beta_1,\beta_2$ 及其[[~/文档/note/离散数学/Disc_Math.org::MK279][父节点]] $\delta,\lambda$
