...
则根据[[~/文档/note/数理逻辑/sllj.org::MK158][满足]] $v_1(x_2)=I(c_0)$ 由于 $I(f_s)$ 是[[~/文档/note/离散数学/Disc_Math.org::MK194][函数]]故有 $I(f_s)(v_1(x_2))=I(f_s)(I(c_0))$ ，即根据[[~/文档/note/数理逻辑/sllj.org::MK158][满足]] $\left<\mathcal{M},v_1\right>\vDash(f_s(x_2)\hat{ =}f_s(\tau_0))$
...
即有对于任意 $\{n,m\}\subset\mathbb{N}$ 且 $n\ne m$ 有 $e(n)\ne e(m)$ 即是[[~/文档/note/离散数学/Disc_Math.org::MK195][单射]]
...
任取 $\Gamma_0\subset\Gamma$ 为[[~/文档/note/离散数学/Disc_Math.org::MK42][有限集]]，则可取 $m$ 满足对于所有 $p_<(\tau_j,x_1)\in\Gamma_0-T$ 均有 $j<m$
...
综上所述，对于任意 $\Gamma$ 的[[~/文档/note/离散数学/Disc_Math.org::MK42][有限子集]] $\Gamma_0$ 均存在 $\mathcal{N}$ 的[[~/文档/note/数理逻辑/sllj.org::MK154][赋值]]满足 $\left<\mathcal{N},v\right>\vDash\Gamma_0$ 根据[[~/文档/note/数理逻辑/sllj.org::MK254][完备性定理]]可得 $\Gamma_0$ [[~/文档/note/数理逻辑/sllj.org::MK222][一致]]
...
$\mu_{x_1}$ 是[[~/文档/note/离散数学/Disc_Math.org::MK194][函数]]

****** 证明

给定 $\mathcal{M},v,(\exists x_1\phi)$ 且 $V\ne\varnothing$ 若 $\mu$ 不是[[~/文档/note/离散数学/Disc_Math.org::MK194][函数]]，假设存在两个及以上 $v^*\in V$ 满足任意 $v\in V$ 均有 $\left<v,v^*\right>\not\in I(p_<)$
...
$\mu_{x_1<\tau}$ 是[[~/文档/note/离散数学/Disc_Math.org::MK194][函数]]
...
根据[[MK52][等价表达]]可得 $\mathcal{M}\vDash\mu(\phi,x_1,x_{n+1})[a,v(x_2),...,v(x_n),b]$ 即 $\mathcal{M}\vDash\mu(\phi\lor(x_1\hat{=}x_{n+1}),x_1)[a,v(x_2),...,v(x_n),b]$ 
...
满足 $\mu(\mathcal{M},v,(\exists x_1\phi))=I(c_0)$ 又根据[[MK28][性质]]可得 $\mu$ 是[[~/文档/note/离散数学/Disc_Math.org::MK194][函数]]，故不存在其他元素 $c\in M$ 满足 $\mu(\mathcal{M},v,(\exists x_1\phi))=c$

即可得 $\left<a,b\right>\in I(p_<)$ 则有 $\text{Sub}(\mathcal{M},a,b)=\mu(\mathcal{M},v,(\exists x_1\phi))=I(c_0)$

***** 性质2<<MK42>>

$\text{Sub}(\mathcal{M},a,b)$ 是[[~/文档/note/离散数学/Disc_Math.org::MK194][函数]]

****** 证明

根据定义有 $\text{Sub}(\mathcal{M},a,b)=\mu_{x_1}(\mathcal{M},v,((f_+(x_3,x_1)\hat{=}x_2)\lor p_<(x_2,x_3)))$

根据[[MK28][性质]]可得 $\mu_{x_1}(\mathcal{M},v,((f_+(x_3,x_1)\hat{=}x_2)\lor p_<(x_2,x_3)))$ 是[[~/文档/note/离散数学/Disc_Math.org::MK194][函数]]，故 $\text{Sub}(\mathcal{M},a,b)$ 亦是[[~/文档/note/离散数学/Disc_Math.org::MK194][函数]]
...
若 $\mathcal{M}=\mathcal{N}$ 是[[MK27][自然数模型]]，则 $\text{OP}(\mathcal{N},a,b)$ 是 $\mathbb{N}\times\mathbb{N}\to\mathbb{N}$ 的[[~/文档/note/离散数学/Disc_Math.org::MK195][单射函数]]
...
$\beta(\mathcal{M},a,i)$ 是[[~/文档/note/离散数学/Disc_Math.org::MK194][函数]]
...
又根据[[MK71][性质]]可得 $\mu_{x_1<\text{Sub}\left(a,I(f_s)(I(c_0))\right)}\left(\mathcal{M},v,\left(\exists x_{4<x_2}\left(\exists x_{5<x_2}\left((x_2\hat{=}op(x_4,x_5))\land\phi(x_4,x_1,x_3,x_5)\right)\right)\right)\right)$ 是[[~/文档/note/离散数学/Disc_Math.org::MK194][函数]]

故 $\beta(\mathcal{M},a,i)$ 是[[~/文档/note/离散数学/Disc_Math.org::MK194][函数]]
...
由于任意 $v^*\in V^*$ 均有 $v^*(x_2)=a$ 且论域为 $\mathbb{N}$ ，又根据[[MK34][性质]]可得 $\text{OP}(\mathcal{N},a,b)$ 是 $\mathbb{N}\times\mathbb{N}\to\mathbb{N}$ 的[[~/文档/note/离散数学/Disc_Math.org::MK195][单射函数]]
...
（2） $\mathbb{N}\times\mathbb{N}\to\mathbb{N}-\{1\}$ 的[[~/文档/note/离散数学/Disc_Math.org::MK200][双射]]
...
即是[[~/文档/note/离散数学/Disc_Math.org::MK195][单射]]
...
故可得 $b\in\mathbb{N}$ 。综上所述，对于任意 $n\in \mathbb{N}-1$ 均存在 $\{a,b\}\subset\mathbb{N}$ 使得 $J(a,b)=n$ 即是[[~/文档/note/离散数学/Disc_Math.org::MK198][满射]]

** 等价[[~/文档/note/数理逻辑/sllj.org::MK129][表达式]]

*** [[~/文档/note/离散数学/Disc_Math.org::MK194][函数]]等价表达<<MK102>>

对于 $n$ 元[[~/文档/note/离散数学/Disc_Math.org::MK194][函数]] $f:\mathbb{N}^n\to \mathbb{N}$ 以及[[MK27][自然数标准模型]] $\mathfrak{N}$ 若存在表达式 $\phi$ 包含 $x_1,...,x_n,x_{n+1}$

满足对于 $\mathfrak{N}$ 的任意[[~/文档/note/数理逻辑/sllj.org::MK154][赋值]] $v$ 有 $\left<\mathfrak{N},v\right>\vDash\phi$ 的充要条件是 $f(v(x_1),...,v(x_n))=v(x_{n+1})$

则称 $\phi$ 是 $f$ 的等价表达式。为方便，可记作 $\phi(\vec{x},y)$

**** 性质1（[[~/文档/note/离散数学/Disc_Math.org::MK737][复合]]）<<MK103>>

若有任意 $f:\mathbb{N}^m\to \mathbb{N}$ 以及 $g_1,...,g_k:\mathbb{N}^n\to \mathbb{N}$ 均有[[MK102][等价表达式]]

则其[[~/文档/note/离散数学/Disc_Math.org::MK737][复合]] $f\cdot(g_1,...,g_k)$ 亦有[[MK102][等价表达式]]
...
则其[[~/文档/note/离散数学/Disc_Math.org::MK737][复合]] $f\cdot(g_1,...,g_k)$ 的[[MK102][等价表达式]] $\phi$ 亦有
...
*** [[~/文档/note/离散数学/Disc_Math.org::MK736][关系]]等价表达<<MK105>>

对 $n$ 元[[~/文档/note/离散数学/Disc_Math.org::MK736][关系]] $R\subset \mathbb{N}^n$ 以及[[MK27][自然数标准模型]] $\mathfrak{N}$ 若存在表达式 $\phi(x_1,...,x_n)$
...
若 $n$ 元[[~/文档/note/离散数学/Disc_Math.org::MK736][关系]] $R\subset M^n$ 存在[[MK105][等价表达式]]的充要条件是[[MK74][特征函数]] $\chi_R$ 亦存在[[MK105][等价表达式]]
...
若 $n$ 元[[~/文档/note/离散数学/Disc_Math.org::MK736][关系]] $R\subset M^n$ 的[[MK105][等价表达式]] $\psi$ ，其的[[MK74][特征函数]] $\chi_R$ 存在[[MK105][等价表达式]] $\phi$ 则
...
若 $R,Q$ 均为 $M$ 上的 $n$ 元[[~/文档/note/离散数学/Disc_Math.org::MK736][关系]]且存在[[MK105][等价表达]]，则其[[MK108][布尔组合]]亦存在[[MK105][等价表达]]
...
若 $R,Q$ 均为 $M$ 上的 $n$ 元[[~/文档/note/离散数学/Disc_Math.org::MK736][关系]]，其[[MK102][等价表达式]]分为 $\phi,\psi$ 且满足
...
若 $n$ 元[[~/文档/note/离散数学/Disc_Math.org::MK736][关系]] $R\subset \mathbb{N}^n$ 的[[MK105][等价表达式]] $\psi$ 满足对于任意 $\mathcal{L}_{\mathcal{A}_{N}}$ 的[[~/文档/note/数理逻辑/sllj.org::MK153][结构]] $\mathcal{M} =\left<M,I\right>\vDash T_{N}$ 任意 $\mathfrak{N}$ 的[[~/文档/note/数理逻辑/sllj.org::MK154][赋值]] $v$
...
根据[[MK109][性质1]]可得 $\chi_R$ 存在[[MK102][等价表达]]，根据定义可得 $\chi_{R'}(\vec{a})=\chi_R(\pi^n_{i_1}(\vec{a}),...,\pi^n_{i_m}(\vec{a}))$ 即 $\chi_{R'}$ 是 $\chi_R$ 与 $\pi^i_j$ 的[[~/文档/note/离散数学/Disc_Math.org::MK737][复合]]
...
由于 $\chi_{R'}$ 是 $\chi_R$ 与 $\pi^i_j$ 的[[~/文档/note/离散数学/Disc_Math.org::MK737][复合]]，则根据[[MK136][性质2]]可得 $\chi_{R'}$ 的[[MK102][等价表达]] $\phi_2$ 亦有 $\left<\mathfrak{N},v\right>\vDash\phi_2$ 的充要条件是 $\left<\mathcal{M},v\cdot e\right>\vDash\phi_2$ 
...
根据[[~/文档/note/数理逻辑/sllj.org::MK111][定义]] $\Sigma$ 为所有[[~/文档/note/数理逻辑/sllj.org::MK105][符号]]的集合，定义[[~/文档/note/离散数学/Disc_Math.org::MK194][函数]] $SN:\Sigma\to\mathbb{N}$ 如下
...
$SN$ 是[[~/文档/note/离散数学/Disc_Math.org::MK195][单射函数]]

***** 证明

根据[[MK39][引理3]]可得 $J(a,b)>a$ 且为[[~/文档/note/离散数学/Disc_Math.org::MK200][双射]]，则显然易证[[~/文档/note/数理逻辑/sllj.org::MK105][固定符号]]均小于其他符号
...
根据[[MK39][引理3]]亦可得 $J$ 为[[~/文档/note/离散数学/Disc_Math.org::MK200][双射]]，故显然 $SN$ 是[[~/文档/note/离散数学/Disc_Math.org::MK195][单射函数]]
...
定义递归函数集 $\mathscr{R}$ 为包含如下[[~/文档/note/离散数学/Disc_Math.org::MK194][函数]]的最小[[~/文档/note/离散数学/Disc_Math.org::MK194][函数]]集合：

（1） 基本函数：

     a） 包含[[MK27][自然数标准模型中]] $\{\mathfrak{J}(f_+),\mathfrak{J}(f_\times),\mathfrak{J}(f_s),\chi_{\mathfrak{J}(p_<)}\}$ 其中 $\chi_{\mathfrak{J}(p_<)}$ 为[[~/文档/note/离散数学/Disc_Math.org::MK736][关系]] $\mathfrak{J}(p_<)$ 的[[MK74][特征函数]]
...
（2） 生成函数：
     ...
     a） 任意 $f:\mathbb{N}^k\to\mathbb{N}$ 以及 $g_1,...,g_k:\mathbb{N}^n\to\mathbb{N}$ 满足 $\{f,g_1,...,g_k\}\subset\mathscr{R}$ 则有其[[~/文档/note/离散数学/Disc_Math.org::MK737][复合]] $f\cdot(g_1,...,g_k)\in\mathscr{R}$
...
对于任意 $n$ 元[[~/文档/note/离散数学/Disc_Math.org::MK736][关系]] $R\subset\mathbb{N}^n$ 若有 $\chi_R\in\mathscr{R}$ 则称 $R$ 是递归关系
...
任意[[~/文档/note/离散数学/Disc_Math.org::MK194][函数]] $g:\mathbb{N}^{n+1}\to\mathbb{N}$ 存在 $f:\mathbb{N}^n\to\mathbb{N}$ 满足：
...
对于 $\mathcal{L}_{\mathcal{A}_{N}}$ 的任意[[~/文档/note/数理逻辑/sllj.org::MK153][结构]] $\mathcal{M} =\left<M,I\right>\vDash T_{N}$ 以及在 $M$ 上的 $n$ 元[[~/文档/note/离散数学/Disc_Math.org::MK736][关系]] $R\subset M^n$
...
则称 $\chi_R$ 是[[~/文档/note/离散数学/Disc_Math.org::MK736][关系]] $R\subset M^n$ 的特征函数

**** [[~/文档/note/离散数学/Disc_Math.org::MK736][关系]]的布尔组合<<MK108>>

对于 $\mathcal{L}_{\mathcal{A}_{N}}$ 的任意[[~/文档/note/数理逻辑/sllj.org::MK153][结构]] $\mathcal{M} =\left<M,I\right>\vDash T_{N}$ 以及在 $M$ 上的 $n$ 元[[~/文档/note/离散数学/Disc_Math.org::MK736][关系]] $R\subset M^n,Q\subset M^n$ 其布尔组合定义如下：
...
***** 非对称[[~/文档/note/离散数学/Disc_Math.org::MK736][关系]]的布尔组合<<MK86>>
...
任意 $n$ 元[[~/文档/note/离散数学/Disc_Math.org::MK736][关系]] $R\subset \mathbb{N}^n,Q\subset \mathbb{N}^n$ ，对于任意 $\{a,b,c\}\in\mathbb{N}$ 定义：
...
则称上述四个函数以及其有限[[~/文档/note/离散数学/Disc_Math.org::MK737][复合]]为关系的布尔组合表达式
...
根据[[MK81][定义]]可得 $\{\chi_R,\chi_Q\}\subset\mathscr{R}$ ，则根据[[MK89][性质0]]可得[[~/文档/note/离散数学/Disc_Math.org::MK194][函数]] $f$ 满足 $f(\vec{a})=\mathfrak{J}(f_\times)(\chi_R(\vec{a}),\chi_Q(\vec{a}))\in\mathscr{R}$
...
根据[[MK82][之前证明]]可得[[~/文档/note/离散数学/Disc_Math.org::MK33][补集]] $\overline{R},\overline{Q}$ 亦分别为 $m,n$ 元[[MK81][递归关系]]，则根据上一步同理可证 $\chi_{\left(\overline{R}\land\overline{Q}\right)}\in\mathscr{R}$ 以及 $\chi_{\left(\overline{\overline{R}\land\overline{Q}}\right)}\in\mathscr{R}$ 
...
同理[[~/文档/note/离散数学/Disc_Math.org::MK737][复合函数]] $f(\vec{a})=\mathfrak{J}(f_\times)(\chi_{\overline{R}}(\vec{a}),\chi_Q(\vec{a}))\in\mathscr{R}$ 显然 $f(\vec{a})=\begin{cases}1&\chi_R(\vec{a})=0\lor\chi_Q(\vec{a})=1\\0&else\end{cases}$ 即 $f=\chi_{R\to Q}$
...
**** [[~/文档/note/离散数学/Disc_Math.org::MK736][关系]]的量词计算<<MK87>>
...
其中上述计算为[[~/文档/note/离散数学/Disc_Math.org::MK736][关系]]的[[MK86][布尔组合]]和[[MK87][量词计算]]。则 $R,Q$ 亦为[[MK81][递归关系]]
...
则根据[[MK81][定义]]有[[~/文档/note/离散数学/Disc_Math.org::MK737][复合函数]] $\chi_Q\in\mathscr{R}$
...
设 $g:\mathbb{N}^{n+1}\to\mathbb{N}$ 是[[~/文档/note/离散数学/Disc_Math.org::MK194][函数]] $f$ 是由 $g$ 递归定义的当且仅当对于任意 $\vec{a}\in\mathbb{N}^{n-1},a\in\mathbb{N}$ 均有 $f(a,\vec{a})=g\left(\prec f(0,\vec{a}),...,f(a-1,\vec{a})\succ,a,\vec{a}\right)$

其中 $\prec f(0,\vec{a}),...,f(a-1,\vec{a})\succ$ 表示 $\left< f(0,\vec{a}),...,f(a-1,\vec{a})\right>$ 的[[MK38][哥德尔数]]

***** 定理<<MK160>>

对于任意 $g:\mathbb{N}^{n+1}\to\mathbb{N}$ 是[[~/文档/note/离散数学/Disc_Math.org::MK194][函数]]存在唯一 $f$ 是 $g$ [[MK115][递归定义]]的
...
对于任意 $g:\mathbb{N}^{n+1}\to\mathbb{N}$ 是[[~/文档/note/离散数学/Disc_Math.org::MK194][函数]]若有 $g\in\mathscr{R}$ 则有其[[MK115][递归定义]]的 $f\in\mathscr{R}$
...
任意[[~/文档/note/离散数学/Disc_Math.org::MK194][函数]] $p:P_1\to P_2$ 定义[[~/文档/note/离散数学/Disc_Math.org::MK194][函数]] $h$ 满足对于任意 $\vec{a}=\left<a_1,...,a_z\right>\in\mathbb{N}^z$ 有 $h(\vec{a})=f\left(g_1(a_{p(1,1)},...,a_{p(1,n_1)}),...,g_k(a_{p(k,1)},...,a_{p(k,n_k)})\right)$
...
若 $R$ 为 $n$ 元[[MK81][递归关系]] $g_1,...,g_n$ 为[[MK81][递归函数]]，则定义 $R'$ 为 $m$ 元[[~/文档/note/离散数学/Disc_Math.org::MK736][关系]]满足对于任意 $\vec{a}\in\mathbb{N}^k$
...
[[~/文档/note/离散数学/Disc_Math.org::MK737][复合]]函数 $f=\chi_R\cdot(g_1(a_{k_{1,1}},...,a_{k_{1,n_1}}),...,g_n(a_{k_{n,1}},...,a_{k_{n,n_n}}))\in\mathscr{R}$ 显然 $f$ 即为 $R'$ 的[[MK74][特征函数]]
...
根据[[MK81][定义]]可得 $\{\pi^2_1,\pi^2_2\}\subset\mathscr{R}$ 则[[~/文档/note/离散数学/Disc_Math.org::MK737][复合函数]] $f=\chi_{\mathfrak{J}(p_<)}\cdot(\pi^2_2,\pi^2_1)\in\mathscr{R}$ 显然对于任意 $\left<a,b\right>\in\mathbb{N}^2$
...
[[~/文档/note/离散数学/Disc_Math.org::MK194][函数]] $f(a,b)=\mu_x(\chi_{((b+x=a)\lor_p(a<b))}(a,b,x)=1)$ 是[[MK81][递归函数]]
...
若 $g_1,...,g_k$ 均为 $n$ 元[[MK81][递归函数]] $R_1,...,R_k$ 均为 $n$ 元[[MK81][递归关系]]并且形成 $\mathbb{N}^n$ 上的[[~/文档/note/离散数学/Disc_Math.org::MK179][划分]]

对于任意 $\vec{a}\in\mathbb{N}^n$ 则[[~/文档/note/离散数学/Disc_Math.org::MK194][函数]] $f(\vec{a})=\begin{cases}g_1(\vec{a})&\vec{a}\in R_1\\...\\g_k(\vec{a})&\vec{a}\in R_k\end{cases}$ 亦为 $n$ 元[[MK81][递归函数]]

***** 证明

显然 $\chi_{R_i}\in\mathscr{R}$ 且根据[[MK81][定义]]可得 $\{\mathfrak{J}(f_+),\mathfrak{J}(f_\times)\}\subset\mathscr{R}$ ，则[[~/文档/note/离散数学/Disc_Math.org::MK737][复合函数]] $g'_i=\mathfrak{J}(f_\times)\cdot(\chi_{R_i},g_i)\in\mathscr{R}$
...
若 $Q_1,...,Q_k$ 均为 $n$ 元[[MK81][递归关系]] $R_1,...,R_k$ 均为 $n$ 元[[MK81][递归关系]]并且形成 $\mathbb{N}^n$ 上的[[~/文档/note/离散数学/Disc_Math.org::MK179][划分]]
...
由于 $\text{Seq}\subset\mathbb{N}$ 显然 $\text{Seq}$ 是 $1$ 元[[~/文档/note/离散数学/Disc_Math.org::MK736][关系]]。则有 $\text{Seq}$ 是 $1$ 元[[MK81][递归关系]]
...
**** 性质15（ $\text{In}$ [[~/文档/note/离散数学/Disc_Math.org::MK194][函数]]）<<MK153>>
...
（1） 显然[[~/文档/note/数理逻辑/sllj.org::MK129][表达式]] $(f_+(x_1,x_2)\hat{=}x_3),(f_\times(x_1,x_2)\hat{=}x_3),(f_s(x_1)\hat{=}x_2)$ 分别是[[~/文档/note/离散数学/Disc_Math.org::MK194][函数]] $\mathfrak{J}(f_+),\mathfrak{J}(f_\times),\mathfrak{J}(f_s)$ 的对应[[~/文档/note/数理逻辑/sllj.org::MK129][表达式]]

（2） 显然[[~/文档/note/数理逻辑/sllj.org::MK129][表达式]] $((p_<(x_1,x_2)\land(x_3\hat{=}f_s(c_0)))\lor((\lnot p_<(x_1,x_2))\land(x_3\hat{=}c_0)))$ 是[[~/文档/note/离散数学/Disc_Math.org::MK194][函数]] $\chi_{\mathfrak{J}(p_<)}$ 的对应[[~/文档/note/数理逻辑/sllj.org::MK129][表达式]]
...
为方便，称 $\phi$ 为[[~/文档/note/离散数学/Disc_Math.org::MK194][函数]] $f$ 的对应[[~/文档/note/数理逻辑/sllj.org::MK129][表达式]]
...
推导[[~/文档/note/离散数学/Disc_Math.org::MK736][关系]]：
...
定义 $1$ 元[[~/文档/note/离散数学/Disc_Math.org::MK736][关系]] $a\in\text{Vrble}$ 的充要条件是存在 $i$ 满足 $a=\prec J(7,i)\succ$ 其中
...
定义 $1$ 元[[~/文档/note/离散数学/Disc_Math.org::MK736][关系]] $a\in\text{Cnst}$ 的充要条件是存在 $i$ 满足 $a=\prec J(7,i)\succ$ 其中
...
递归定义 $1$ 元[[~/文档/note/离散数学/Disc_Math.org::MK736][关系]] $\text{Term}$ 满足 $a\in\text{Term}$ 的充要条件是满足以下一条
...
递归定义 $1$ 元[[~/文档/note/离散数学/Disc_Math.org::MK736][关系]] $\text{AFrml}$ 满足 $a\in\text{AFrml}$ 的充要条件是满足以下一条
...
递归定义 $1$ 元[[~/文档/note/离散数学/Disc_Math.org::MK736][关系]] $\text{Frml}$ 满足 $a\in\text{Frml}$ 的充要条件是满足以下一条
...
递归定义 $2$ 元[[~/文档/note/离散数学/Disc_Math.org::MK736][关系]] $\text{Free}$ 满足 $\left<a,b\right>\in\text{Free}$ 的充要条件为满足以下一条：
...
递归定义 $3$ 元[[~/文档/note/离散数学/Disc_Math.org::MK736][关系]] $\text{Stbl}$ 满足 $\left<a,b,c\right>\in\text{Stbl}$ 的充要条件为满足以下一条：
...
递归定义 $3$ 元[[~/文档/note/离散数学/Disc_Math.org::MK736][关系]] $\text{MP}$ 满足 $\left<a,b,c\right>\in\text{MP}$ 的充要条件是 $b=\prec SN((),a,SN(\to),b,SN())\succ$

*** [[~/文档/note/数理逻辑/sllj.org::MK197][逻辑公理]]关系<<MK118>>

定义以下[[~/文档/note/离散数学/Disc_Math.org::MK736][关系]]：
...
满足对于任一上述[[~/文档/note/离散数学/Disc_Math.org::MK736][关系]] $R_\mathbb{L}$ 任意 $a\in\mathbb{N}$ 有 $a\in R_{\mathbb{L}}$ 的充要条件是存在[[~/文档/note/数理逻辑/sllj.org::MK129][表达式]] $\phi\in\mathcal{L}_{\mathcal{A}_N}$ 满足：
...
$\text{Subst}(a,b,c)$ 是[[~/文档/note/离散数学/Disc_Math.org::MK194][函数]]
...
又根据[[MK38][定义]]可得 $a_1<a,a_2<a$ 结合 $a<\infty$ 以及数学归纳法易证 $\text{Subst}(a,b,c)$ 是[[~/文档/note/离散数学/Disc_Math.org::MK194][函数]]
...
定义[[~/文档/note/离散数学/Disc_Math.org::MK736][关系]] $\text{NLAX}_N\subset\mathbb{N}$ 满足对于任意 $a\in\mathbb{N}$ 有 $a\in\text{NLAX}_N$ 的充要条件是：
...
定义[[~/文档/note/离散数学/Disc_Math.org::MK736][关系]] $\text{NLAX}_{PA}\subset\mathbb{N}$ 满足对于任意 $a\in\mathbb{N}$ 有 $a\in\text{NLAX}_{PA}$ 的充要条件是：
...
根据[[MK97][性质1]]、[[MK166][性质3]]、[[MK142][性质4]]、[[MK167][性质2]]以及 $\mathcal{L}_{\mathcal{A}_{PA}}$ 中[[~/文档/note/数理逻辑/sllj.org::MK110][谓词符号]]于[[~/文档/note/数理逻辑/sllj.org::MK109][函数符号]]均有限易证上述用到的[[~/文档/note/离散数学/Disc_Math.org::MK736][关系]]均为[[MK81][递归关系]]、[[~/文档/note/离散数学/Disc_Math.org::MK194][函数]]均为[[MK81][递归函数]]
