...
运算是集合 $S^n=S\times ...\times S$（即 $n$ 个 $S$ 的[[~/文档/note/离散数学/Disc_Math.org::MK153][笛卡尔积]]）到 $S$ 的[[~/文档/note/离散数学/Disc_Math.org::MK194][函数]] 
...
两个[[MK298][代数结构]] $<S,*>,<\bar{S},\bar{*}>$ 若满足 $|S|=|\bar{S}|$ 即集合[[~/文档/note/离散数学/Disc_Math.org::MK3][基数]]相等

** 同态映射<<MK344>>

[[~/文档/note/数理逻辑/sllj.org::MK151][一阶语言]] $\mathcal{L}_\mathcal{A}$ 下有[[~/文档/note/数理逻辑/sllj.org::MK153][结构]] $\mathcal{M}=\left<M,I\right>,\mathcal{N}=\left<N,J\right>$ 存在[[~/文档/note/离散数学/Disc_Math.org::MK194][函数]] $e:M\to N$ 满足：
...
[[MK338][结构]] $\mathcal{M}=\left<M,I\right>$ 是[[MK309][环]]且 $N\subset M$ 是 $\mathcal{M}$ 的[[MK348][理想]]，则定义[[~/文档/note/离散数学/Disc_Math.org::MK155][关系]] $\sim$ 满足对于任意 $\{a,b\}\subset M$ 若存在 $c\in N$ 满足 $a=I(f_+)(b,c)$ 则 $\left<a,b\right>\in\sim$

称 $\sim$ 是[[MK309][环]] $\mathcal{M}$ 在其[[MK348][理想]] $N$ 上的同余关系

**** 商环<<MK354>>

若[[MK338][结构]] $\mathcal{M}=\left<M,I\right>$ 是[[MK309][环]]且 $N\subset M$ 是 $\mathcal{M}$ 的[[MK348][理想]]，[[~/文档/note/离散数学/Disc_Math.org::MK155][关系]] $\sim$ 是[[MK309][环]] $\mathcal{M}$ 在其[[MK348][理想]] $N$ 上的[[MK352][同余关系]]，则定义：

（1） $M/N=\left\{[a]_\sim\big|a\in M\right\}$ 为 $\sim$ 的[[~/文档/note/离散数学/Disc_Math.org::MK177][等价类]]（根据[[MK355][定理1]]可得[[MK352][同余关系]]是[[~/文档/note/离散数学/Disc_Math.org::MK176][等价关系]]）
...
由于是[[~/文档/note/离散数学/Disc_Math.org::MK194][函数]]故有 $J(c_0)=J(f_+)(\eta(I(c_0)),b)=J(f_+)(J(f_+)(\eta(I(c_0)),\eta(I(c_0))),b)$
...
[[MK338][结构]] $\mathcal{M}=\left<M,I\right>,\mathcal{N}=\left<N,J\right>$ 是[[MK309][环]]，若有[[MK344][同态映射]] $\eta:M\to N$ 是[[~/文档/note/离散数学/Disc_Math.org::MK200][双射]]，则 $\mathcal{M},\mathcal{N}$ [[~/文档/note/数理逻辑/sllj.org::MK274][同构]]
...
又由于 $\eta$ 是[[~/文档/note/离散数学/Disc_Math.org::MK200][双射]]，故满足[[~/文档/note/数理逻辑/sllj.org::MK274][同构定义]]
...
故若 $I(f_+)(a,b)=I(c_0)$ 则有 $I(f_+)(b,a)=I(c_0)$ ，故根据[[MK304][性质2]]可得存在唯一 $b\in M$ 满足 $I(f_+)(a,b)=I(c_0)$
...
[[MK338][结构]] $\mathcal{M}=\left<M,I\right>$ 是[[MK309][环]]则有 $\mathcal{M}\vDash(\forall x_1(x_1\hat{=}f_-(f_-(x_1))))$

***** 证明

定义 $+,-,0$ 分别代表 $I(f_+),I(f_-),I(c_0)$ ，则根据[[MK349][性质7]]可得对于任意 $a\in M$ 均有 $(-a)+(-(-a))=0$

两边加 $a$ 则有 $a=a+((-a)+(-(-a)))$ 根据[[MK349][性质7]]中结合律 $a=(a+(-a))+(-(-a))=(-(-a))$

又根据[[~/文档/note/数理逻辑/sllj.org::MK158][满足]]易证 $\mathcal{M}\vDash(\forall x_1(x_1\hat{=}f_-(f_-(x_1))))$ 
...
[[MK352][同余关系]]是[[~/文档/note/离散数学/Disc_Math.org::MK176][等价关系]]

***** 证明

若[[MK338][结构]] $\mathcal{M}=\left<M,I\right>$ 是[[MK309][环]]且 $N\subset M$ 是 $\mathcal{M}$ 的[[MK348][理想]]，[[~/文档/note/离散数学/Disc_Math.org::MK155][关系]] $\sim$ 是[[MK309][环]] $\mathcal{M}$ 在其[[MK348][理想]] $N$ 上的[[MK352][同余关系]]，则：

（1） 对于任意 $a\in M$ 根据[[MK348][理想定义]]可得 $I(c_0)\in N$ ，根据[[MK349][性质7]]可得 $a=I(f_+)(a,I(c_0))$ 故可得 $\left<a,a\right>\in\sim$ 即[[~/文档/note/离散数学/Disc_Math.org::MK168][自反性]]
...
（2） 对于任意 $a\sim b$ 有 $c\in N$ 则根据[[MK350][性质8]]以及[[MK348][理想定义]]可得 $I(f_\times)(-I(c_1),c)=-c\in N$
     ...
     即若 $\left<a,b\right>\in r$ 则 $\left<b,a\right>\in\sim$ 即[[~/文档/note/离散数学/Disc_Math.org::MK170][对称性]]
...
（3） 对于任意 $\{a,b,c\}\subset M$ 若有 $a\sim b,b\sim c$ 根据定义有 $\{z_1,z_2\}\subset N$ 满足 $a=I(f_+)(b,z_1),b=I(f_+)(c,z_2)$
     ...
     故可得 $a\sim c$ 即[[~/文档/note/离散数学/Disc_Math.org::MK172][传递性]]

综上所属 $\sim$ 是[[~/文档/note/离散数学/Disc_Math.org::MK176][等价关系]]
...
若[[MK338][结构]] $\mathcal{M}=\left<M,I\right>$ 是[[MK362][非零幺环]]且 $N\subset M$ 是 $\mathcal{M}$ 的[[MK348][理想]]，[[~/文档/note/离散数学/Disc_Math.org::MK155][关系]] $\sim$ 是[[MK309][环]] $\mathcal{M}$ 在其[[MK348][理想]] $N$ 上的[[MK352][同余关系]]，则定义：
...
则其[[MK399][分式关系]]是[[~/文档/note/离散数学/Disc_Math.org::MK176][等价关系]]
...
即有 $\frac{a}{b}\sim\frac{a}{b}$ 即满足[[~/文档/note/离散数学/Disc_Math.org::MK168][自反性]]
...
故可得 $\frac{c}{d}\sim\frac{a}{b}$ 即满足[[~/文档/note/离散数学/Disc_Math.org::MK170][对称性]]
...
又根据[[MK400][性质4]]可得 $I(f_\times)(a,y)=I(f_\times)(x,b)$ 即有 $\frac{a}{b}\sim\frac{x}{y}$ 即满足[[~/文档/note/离散数学/Disc_Math.org::MK172][传递性]]
...
即有 $\frac{I(c_0)}{a}\sim\frac{I(c_0)}{b}$ 根据[[~/文档/note/离散数学/Disc_Math.org::MK629][定理1]]可得 $\left[\frac{I(c_0)}{a}\right]_\sim=\left[\frac{I(c_0)}{b}\right]_\sim$
...
即有 $\frac{a}{b}\sim\frac{I(f_\times)(a,c)}{I(f_\times)(b,c)}$ 根据[[~/文档/note/离散数学/Disc_Math.org::MK629][定理1]]可得 $\left[\frac{a}{b}\right]_\sim=\left[\frac{I(f_\times)(a,c)}{I(f_\times)(b,c)}\right]_\sim$
...
根据[[MK401][性质]]可得 $\sim$ 是 $M_\div$ 上的[[~/文档/note/离散数学/Disc_Math.org::MK176][等价关系]]，则进一步定义 $M_{[\div]}=\left\{[a]_\sim\big|a\in M_\div\right\}$ 是 $M_\div$ 关于 $\sim$ 的[[~/文档/note/离散数学/Disc_Math.org::MK177][等价类]]
...
根据[[~/文档/note/离散数学/Disc_Math.org::MK629][定理1]]可得 $I_{[\div]}(c_0)=\left[\frac{I(c_0)}{I(c_1)}\right]_\sim\ne\left[\frac{I(c_1)}{I(c_1)}\right]_\sim=I_{[\div]}(c_1)$ 
...
即是[[~/文档/note/离散数学/Disc_Math.org::MK194][函数]]

******** 是[[~/文档/note/离散数学/Disc_Math.org::MK195][单射]]
...
由于 $e$ 是[[~/文档/note/数理逻辑/sllj.org::MK300][嵌入映射]]，则为[[~/文档/note/离散数学/Disc_Math.org::MK195][单射]]，故有 $I(f_\times)(a,d)=I(f_\times)(c,b)$ 根据[[MK399][分式关系]]以及[[~/文档/note/离散数学/Disc_Math.org::MK629][定理1]]可得 $\left[\frac{a}{b}\right]_\sim=\left[\frac{c}{d}\right]_\sim$ 矛盾
...
******* $e^*$ 是[[~/文档/note/离散数学/Disc_Math.org::MK194][函数]]
...
******* 是[[~/文档/note/离散数学/Disc_Math.org::MK198][满射]]
...
即显然 $\left[\frac{e^{-1}(b_1)}{e^{-1}(b_2)}\right]_\sim\in M_{[\div]}$ 即 $e^*$ 是[[~/文档/note/离散数学/Disc_Math.org::MK198][满射]]
...
易证 $\mathbb{Z}_p=\left<Z_p,I_p\right>$ 是 $\mathcal{L}_{\mathcal{A}_\mathbb{F}}$ 下的[[~/文档/note/数理逻辑/sllj.org::MK153][结构]]
...
若有[[MK344][同态]]映射 $e$ 且为[[~/文档/note/离散数学/Disc_Math.org::MK200][双射]]，则 $e$ 是[[~/文档/note/数理逻辑/sllj.org::MK274][同构映射]]

***** 证明

根据条件有对于任意 $\{a,b\}\subset M$ 有 $e(I(f_+)(a,b))=J(f_+)(e(a),e(b)),e(I(f_\times)(a,b))=J(f_\times)(e(a),e(b))$

且[[~/文档/note/离散数学/Disc_Math.org::MK203][逆函数]] $e^{-1}$ 仍是[[~/文档/note/数理逻辑/sllj.org::MK274][同构映射]]，对于任意 $a\in M$ 有 $I(f_+)(a,e^{-1}(J(c_0)))=e^{-1}(J(f_+)(e(a),J(c_0)))=e^{-1}(e(a))=a$
...
即根据[[MK348][理想定义]] $a\in N$ 。故根据[[~/文档/note/离散数学/Disc_Math.org::MK20][定义]]可得 $M\subset N$ ，又由于 $N\subset M$ 故根据[[~/文档/note/离散数学/Disc_Math.org::MK21][自反性]]有 $N=M$ 
...
故可得 $N\subset M$ ，则根据[[~/文档/note/离散数学/Disc_Math.org::MK21][自反性]]可得 $N=M$
...
则对于任意 $\mathcal{N}=\left<N,J\right>$ 是[[MK309][环]]，若有[[MK344][同态映射]] $\eta:M\to N$ 满足 $\eta$ 不是对于任意 $a\in M$ 均有 $\eta(a)=J(c_0)$ 有 $\eta$ 必为[[~/文档/note/离散数学/Disc_Math.org::MK195][单射]]
...
故假设不成立，即对于任意 $\{a,b\}\subset M,a\ne b$ 有 $\eta(a)\ne\eta(b)$ ，即 $\eta$ 是[[~/文档/note/离散数学/Disc_Math.org::MK195][单射]]
...
则有 $\mathcal{A}_\mathbb{F}=\{f_\times,f_+,f_-,c_0,c_1\}$ 进一步有 $\mathcal{L}_{\mathcal{A}_\mathbb{F}}$ 是环理论的[[~/文档/note/数理逻辑/sllj.org::MK151][语言]]
...
任意[[MK338][域结构]] $\mathcal{M}=\left<M,I\right>$ 对于任意 $a\in M$ 定义 $a_i=f_+(a,f_+(...f_+(a,a)...) )$ 即 $i$ 个 $a$ 相加

若[[MK339][特征]]不为 $p$ 且 $a\ne I(c_0)$ 则 $\mathcal{M}\vDash(\lnot(a_p\hat{=}c_0))$

****** 证明

根据[[MK356][性质4]]中乘法分配可得 $(a+...+a)=I(f_\times)(a,1+...+1)=I(f_\times)(a,I(\tau_p))$ 根据[[MK339][特征]]不为 $p$ 可得 $I(\tau_p)\ne I(c_0)$

结合[[MK340][性质2]]以及 $a\ne I(c_0)$ 即可得 $I(f_\times)(a,I(\tau_p))\ne I(c_0)$ ，根据[[~/文档/note/数理逻辑/sllj.org::MK158][满足]] $\mathcal{M}\vDash(\lnot(a_p\hat{=}c_0))$
...
故若 $M_{(S_1\cup S_2)}=\left(M_{(S_1)}\right)_{(S_2)}$ 即有两个[[~/文档/note/数理逻辑/sllj.org::MK153][结构]]相同。根据以下步骤以及[[~/文档/note/离散数学/Disc_Math.org::MK4][伯恩斯坦定理]]可得 $M_{(S_1\cup S_2)}=\left(M_{(S_1)}\right)_{(S_2)}$
...
又由于 $I_S$ 为 $J$ 在 $M_S$ 上的[[~/文档/note/数理逻辑/sllj.org::MK481][限制解释]]故 $\mathcal{M}_S$ 是 $\mathcal{N}$ 的[[~/文档/note/数理逻辑/sllj.org::MK282][子结构]]。又由于 $\mathcal{N}$ 是[[MK338][域]]，则显然 $\mathcal{N}$ 满足[[MK373][非零幺环公理]]以及上述（1）、（2）[[~/文档/note/数理逻辑/sllj.org::MK129][表达式]]
...
******** 是 $\mathcal{L}_{\mathcal{A}_\mathbb{F}}$ 上的[[~/文档/note/数理逻辑/sllj.org::MK153][结构]]
...
故可得 $\mathcal{M}_{(A)}$ 是 $\mathcal{L}_{\mathcal{A}_\mathbb{F}}$ 上的[[~/文档/note/数理逻辑/sllj.org::MK153][结构]]

******** $\mathcal{M}_{(A)}\vDash T_\mathbb{F}$

由于 $I_{(A)}$ 是 $J$ 在 $M_{(A)}$ 上的[[~/文档/note/数理逻辑/sllj.org::MK481][限制解释]]且根据上一步证明可得 $\mathcal{M}_{(A)}$ 是 $\mathcal{L}_{\mathcal{A}_\mathbb{F}}$ 上的[[~/文档/note/数理逻辑/sllj.org::MK153][结构]]，故对于任意 $\{a,b\}\subset M_{(A)}$
...
由于 $S$ 在 $\mathcal{M}$ 上[[MK445][代数无关]]，故 $\mathcal{M}_{(S)}$ 是 $\mathcal{M}$ 的[[MK451][超越扩张]]，则根据[[MK509][推论2]]可得 $M_{(S)}$ 是[[~/文档/note/离散数学/Disc_Math.org::MK43][无限集]]
...
（2） 若 $K\ne\varnothing$ 则超越基为 $K$ 的[[~/文档/note/离散数学/Disc_Math.org::MK186][极大]]的[[MK445][代数无关]]子集
...
若 $K\ne\varnothing$ 则定义 $\rho'(K)$ 为 $K$ 上所有的[[MK445][代数无关]]子集的集合，定义 $L=\left<\rho'(K),\subset\right>$ 为 $\rho'(K)$ 上关于 $\subset$ 的[[~/文档/note/离散数学/Disc_Math.org::MK185][偏序关系]]

则对于 $L$ 上的任意[[~/文档/note/离散数学/Disc_Math.org::MK386][链]] $T$ 定义 $t^*=\bigcup_{t\in T}t$ 显然 $t^*$ 中所有元素均为 $\mathcal{M}$ 上的[[MK395][代数元]]，即 $t^*\subset K$

又根据 $T$ 是[[~/文档/note/离散数学/Disc_Math.org::MK386][链]]，任意 $t\in T\subset \rho'(K)$ [[MK445][代数无关]]，则根据[[MK450][性质1]]可得 $t^*$ [[MK445][代数无关]]，即 $t^*\in\rho'(K)$

又根据 $t^*$ 定义可得对于任意 $t\in T$ 均有 $t\subset t^*$ 。即 $t^*$ 是 $T$ 的[[~/文档/note/离散数学/Disc_Math.org::MK326][上界]]

又根据 $T$ 的任意性以及[[~/文档/note/离散数学/Disc_Math.org::MK390][佐恩引理]]可得存在 $\rho'(K)$ 上的[[~/文档/note/离散数学/Disc_Math.org::MK186][极大元]]，即为[[MK438][超越基]]
...
则根据[[MK478][性质3]]可得 $S\cup\{a\}$ 在 $\mathcal{M}$ 上[[MK445][代数无关]]，即与 $S$ 的[[~/文档/note/离散数学/Disc_Math.org::MK186][极大性]]矛盾
...
******* 性质2（[[~/文档/note/离散数学/Disc_Math.org::MK27][等势]]）<<MK504>>

任意 $\mathcal{M}=\left<M,I\right>$ 是 $\mathcal{N}=\left<N,J\right>$ 的[[MK341][子域]]，则 $\mathcal{N}$ 在 $\mathcal{M}$ 上的任意[[MK438][超越基]]均[[~/文档/note/离散数学/Disc_Math.org::MK27][等势]]

******** 证明

********* [[~/文档/note/离散数学/Disc_Math.org::MK42][有限]]
...
********* [[~/文档/note/离散数学/Disc_Math.org::MK43][无限]]

********** 对于任意 $s\in S$ 定义 $T_s$

设[[MK438][超越基]]为 $S$ 是[[~/文档/note/离散数学/Disc_Math.org::MK43][无限]]集，对于任意其他一组[[MK438][超越基]] $T$ 根据上一步证明可得 $T$ 亦为[[~/文档/note/离散数学/Disc_Math.org::MK43][无限]]集
...
根据[[MK477][最小性]]易证必有 $T\subset\bigcup_{s\in S}T_s$ 根据[[~/文档/note/离散数学/Disc_Math.org::MK21][自反性]]可得 $T=\bigcup_{s\in S}T_s$

********** 定义 $T'_s$ 证明 $\bigcup_{s\in S}T'_s= T$ <<MK479>>

根据[[~/文档/note/离散数学/Disc_Math.org::MK384][良序定理]]定义[[~/文档/note/离散数学/Disc_Math.org::MK384][良序关系]] $\left<S,<\right>$ 对于任意 $s\in S$ 定义 $T'_s=T_s-\bigcup_{s'<s\land s'\in S}T_{s'}$

对于任意 $t\in T=\bigcup_{s\in S} T_s$ 存在非空 $S'\subset S$ 满足对于任意 $s\in S'$ 均有 $t\in T_s$

由于是[[~/文档/note/离散数学/Disc_Math.org::MK384][良序关系]]，则存在[[~/文档/note/离散数学/Disc_Math.org::MK186][最小元]] $s^*$ 进而有对于任意 $s'\in S$ 若有 $s'<s^*$ 则有 $s'\not\in S'$ 即 $t\not\in T_{s'}$

即可得 $t\in T_{s^*}-\bigcup_{s'<s^*\land s'\in S}T_{s'}$ 即有 $t\in T'_s$ ，则有 $T\subset\bigcup_{s\in S}T'_s$ ，显然有 $\bigcup_{s\in S}T'_s\subset T$

进而根据[[~/文档/note/离散数学/Disc_Math.org::MK21][自反性]]可得 $\bigcup_{s\in S}T'_s= T$ 又根据第一步 $|T_s|<\infty$ 且显然 $T'_s\subset T_s$ 故可得 $|T'_s|<\infty$

********** 任意 $t\in T$ 存在唯一 $s\in S$ 满足 $t\in T'_s$

根据上一步证明存在 $T'_s$ 满足 $t\in T'_s$ ，对于任意 $s'\in S$ 由于 $\left<S,<\right>$ 是[[~/文档/note/离散数学/Disc_Math.org::MK384][良序关系]]，故为[[~/文档/note/离散数学/Disc_Math.org::MK193][全序集]]
...
由于 $T'_s$ 唯一且排列唯一，故易证 $\phi$ 是[[~/文档/note/离散数学/Disc_Math.org::MK194][函数]]
...
综上所述，对于任意 $\{t_1,t_2\}\subset T$ 满足 $t_1\ne t_2$ 均有 $\phi(t_1)\ne\phi(t_2)$ 即 $\phi$ 是[[~/文档/note/离散数学/Disc_Math.org::MK195][单射]]

则根据[[~/文档/note/离散数学/Disc_Math.org::MK27][等势]]可得 $|T|\leq|S\times\mathbb{N}|$ ，由于 $S$ 是[[~/文档/note/离散数学/Disc_Math.org::MK43][无限]]集，则根据[[~/文档/note/离散数学/Disc_Math.org::MK729][推论]]可得 $|\mathbb{N}|\leq|S|$

又根据[[~/文档/note/离散数学/Disc_Math.org::MK726][推论]]可得 $|S\times\mathbb{N}|=\max(|S|,|\mathbb{N}|)=|S|$ 则根据[[~/文档/note/离散数学/Disc_Math.org::MK725][定理6]]可得 $|T|\leq|S|$ 

********** 证明 $|T|=|S|$ 

根据上面步骤同理可证 $|S|\leq|T|$ ，则根据[[~/文档/note/离散数学/Disc_Math.org::MK4][伯恩斯坦定理]]可得 $|T|=|S|$ [[~/文档/note/离散数学/Disc_Math.org::MK27][等势]]
...
假设 $K$ 在 $\mathcal{M}$ 上[[MK445][代数无关]]，则根据[[MK495][存在性]]易证存在 $K^*\subset N$ 满足 $K\subset K^*$ 且 $K^*$ 是 $\mathcal{M}$ 上[[~/文档/note/离散数学/Disc_Math.org::MK186][极大]]的[[MK445][代数无关]]集

则 $K^*$ 亦为[[MK495][超越基]]，根据[[~/文档/note/离散数学/Disc_Math.org::MK361][定理7]]可得 $|S|<|K^*|$ 与[[MK504][性质2]]矛盾，故假设不成立。即 $K$ 在 $\mathcal{M}$ 上[[MK445][代数相关]]
...
（2） 有 $S_1,S_2$ 分别是 $\mathcal{M}_1,\mathcal{M}_2$ 上的[[MK445][代数无关]]集合且[[~/文档/note/离散数学/Disc_Math.org::MK27][等势]] $|S_1|=|S_2|$
...
$\mathcal{N}=\left<N,J\right>$ 是 $\mathcal{M}=\left<M,I\right>$ 的[[MK451][超越扩张]]，则 $N$ 是[[~/文档/note/离散数学/Disc_Math.org::MK43][无限集]]
...
即存在 $S\subset N$ 满足是[[~/文档/note/离散数学/Disc_Math.org::MK43][无限集]]，则显然 $N$ 是[[~/文档/note/离散数学/Disc_Math.org::MK43][无限集]]

****** 定理4<<MK486>>

$\mathcal{N}=\left<N,J\right>$ 是 $\mathcal{M}=\left<M,I\right>$ 的[[MK451][代数扩张]]，且 $M$ 是[[~/文档/note/离散数学/Disc_Math.org::MK43][无限集]]则 $|M|=|N|$
...
根据[[MK444][性质1]]， $M$ 是[[~/文档/note/离散数学/Disc_Math.org::MK43][无限集]]以及[[~/文档/note/离散数学/Disc_Math.org::MK729][推论]]易证 $|M|=\left|\bigcup_{n\in\mathbb{N}}M[\vec{x}_n]\right|$ ，显然 $M[x_1]\subset \bigcup_{n\in\mathbb{N}}M[\vec{x}_n]$ 根据[[~/文档/note/离散数学/Disc_Math.org::MK355][定理5]]可得 $|M[x_1]|\leq|\bigcup_{n\in\mathbb{N}}M[\vec{x}_n]|$

又根据[[~/文档/note/离散数学/Disc_Math.org::MK725][定理6]]可得 $|M[x_1]|\leq|M|$ 显然对于任意 $a\in M$ 亦有 $f(x_1)=a\in M[x_1]$ 故同理可得 $|M|\leq\left|M[x_1]\right|$

即根据[[~/文档/note/离散数学/Disc_Math.org::MK4][伯恩斯坦定理]]可得 $|M|=\left|M[x_1]\right|$ ，根据[[~/文档/note/离散数学/Disc_Math.org::MK27][等势]]存在[[~/文档/note/离散数学/Disc_Math.org::MK200][双射]] $\psi:M\to M[x_1]$
...
又定义[[~/文档/note/离散数学/Disc_Math.org::MK194][函数]] $v_{f(x_1)}:(N-M)\to\mathbb{N}$ 满足任意 $a\in N-M$ 且 $a$ 是 $f(x_1)$ 的[[MK389][根]]，则 $a$ 是该[[MK436][多项式]]的第 $v_{f_(x_1)}(a)$ 个[[MK389][根]]

则定义 $U_a=\left\{\left<f(x_1),v_{f(x_1)}(a)\right>\big|a\in R_{f(x_1)}\right\}$ 根据[[~/文档/note/离散数学/Disc_Math.org::MK10][选择公理]]存在选择函数满足 $s(U_a)\in U_a$
...
综上所述易证 $\phi$ 是[[~/文档/note/离散数学/Disc_Math.org::MK195][单射]]，显然任意 $a\in N-M$ 均有 $\phi(a)\in M[x_1]\times\mathbb{N}$ 根据[[~/文档/note/离散数学/Disc_Math.org::MK27][等势]] $|N-M|\leq|M[x_1]\times\mathbb{N}|$

******** 证明结论

根据上上步可得 $|M|=\left|M[x_1]\right|$ 根据[[~/文档/note/离散数学/Disc_Math.org::MK726][推论]]可得 $|M[x_1]\times\mathbb{N}|=\max\left(|M[x_1]|,|\mathbb{N}|\right)$ 根据 $M$ 是[[~/文档/note/离散数学/Disc_Math.org::MK43][无限集]]以及[[~/文档/note/离散数学/Disc_Math.org::MK729][推论]]易证 $|M[x_1]\times\mathbb{N}|=|M[x_1]|$ 

根据[[~/文档/note/离散数学/Disc_Math.org::MK28][定理1]]可得 $|M[x_1]\times\mathbb{N}|=|M[x_1]|=|M|$ 根据[[~/文档/note/离散数学/Disc_Math.org::MK725][定理6]]可得 $|N-M|\leq|M|$ 

又由于 $N=(N-M)\cup M$ 即有 $|N|=|(N-M)\cup M|$ 根据[[~/文档/note/离散数学/Disc_Math.org::MK616][定理3]]易证 $|(N-M)\cup M|=\max(|N-M|,|M|)$

又根据[[~/文档/note/离散数学/Disc_Math.org::MK28][定理1]]以及 $|N-M|\leq|M|$ 可得 $|N|=|(N-M)\cup M|=\max(|N-M|,|M|)=|M|$
...
由于 $|S_1|=|S_2|$ 故存在[[~/文档/note/离散数学/Disc_Math.org::MK200][双射]] $\phi:S_1\to S_2$ ，对于任意 $a\in M_{1,S_1}$ 根据 $M_{1,S_1}$ 定义可得存在
...
则定义[[~/文档/note/离散数学/Disc_Math.org::MK194][映射]] $e^*:M_{1,S_1}\to M_{2,S_2}$ 满足 $e^*(a)=\sum_{i\in P}\left(e(a_i)\left(\prod_{j\in K_i}\phi(s_j)^{k_{i,j}}\right)\right)$

******** 是[[~/文档/note/离散数学/Disc_Math.org::MK194][函数]]<<MK475>>
...
即 $e^*$ 是[[~/文档/note/离散数学/Disc_Math.org::MK194][函数]]
...
由于 $e$ 是[[~/文档/note/数理逻辑/sllj.org::MK274][同构映射]]，根据[[~/文档/note/数理逻辑/sllj.org::MK275][引理]]有逆同构 $e^{-1}$ ，由于 $\phi$ [[~/文档/note/离散数学/Disc_Math.org::MK200][双射]]则有[[~/文档/note/离散数学/Disc_Math.org::MK203][逆函数]] $\phi^{-1}$ 显然有：
...
由于 $e$ 是[[~/文档/note/数理逻辑/sllj.org::MK274][同构映射]]，根据[[~/文档/note/数理逻辑/sllj.org::MK275][引理]]有逆同构 $e^{-1}$ ，由于 $\phi$ [[~/文档/note/离散数学/Disc_Math.org::MK200][双射]]则有[[~/文档/note/离散数学/Disc_Math.org::MK203][逆函数]] $\phi^{-1}$ ，则对于任意 $b\in M_{2,(S_2)}$
...
******** 定义[[~/文档/note/离散数学/Disc_Math.org::MK185][偏序关系]]<<MK469>>
...
使得 $v_z$ 是 $\mathcal{N}_z$ 与 $\mathcal{M}_z$ 的[[~/文档/note/数理逻辑/sllj.org::MK274][同构映射]]，定义[[~/文档/note/离散数学/Disc_Math.org::MK185][偏序关系]] $Q=\left<V,<\right>$ 满足若 $v_{z_1}<v_{z_2}$ 则有 $v_{z_1}\subset v_{z_2}$ ， $\mathcal{N}_{z_1}$ 是 $\mathcal{N}_{z_2}$ 的[[MK341][子域]]且 $\mathcal{M}_{z_1}$ 是 $\mathcal{M}_{z_2}$ 的[[MK341][子域]]

******** 任意[[~/文档/note/离散数学/Disc_Math.org::MK386][链]] $T$ 有[[~/文档/note/离散数学/Disc_Math.org::MK386][上界]]
...
则根据以下证明可得 $v^*$ 是 $T$ 的[[~/文档/note/离散数学/Disc_Math.org::MK386][上界]]
...
则有 $\{a,b\}\subset N_{z_2}$ 则有 $J_{z_2}(f_+)(a,b)\in N_{z_2},J_{z_2}(f_\times)(a,b)\in N_{z_2}$ 即有 $J^*(f_+)(a,b)\in N^*,J^*(f_\times)(a,b)\in N^*$ 故易证 $\mathcal{N}^*$ 是 $\mathcal{L}_{\mathcal{A}_\mathbb{F}}$ 上的的[[~/文档/note/数理逻辑/sllj.org::MK153][结构]]
...
显然 $e\in Q$ 故 $Q$ 非空，对于任意[[~/文档/note/离散数学/Disc_Math.org::MK386][链]] $T\subset V$ 定义 $v^*=\bigcup_{v\in T}v$ 根据[[~/文档/note/离散数学/Disc_Math.org::MK507][并双射2]]可得 $v^*$ 亦为[[~/文档/note/离散数学/Disc_Math.org::MK200][双射]]
...
根据[[~/文档/note/离散数学/Disc_Math.org::MK390][佐恩引理]]可得存在[[~/文档/note/离散数学/Disc_Math.org::MK186][极大元]] $v^*$ ，根据[[MK469][定义]]可得亦有
...
即 $v^*$ 不是 $V$ 上的[[~/文档/note/离散数学/Disc_Math.org::MK186][极大元]]，矛盾。故假设不成立，即有 $N^*= N_{|S}$ 同理可证 $M^*= M_{|S}$

即可得 $v^*$ 是 $\mathcal{N}_{|S}$ 与 $\mathcal{M}_{|S'}$ 的[[~/文档/note/数理逻辑/sllj.org::MK274][同构映射]]

***** 性质

****** [[~/文档/note/离散数学/Disc_Math.org::MK185][偏序性]]<<MK483>>
...
则 $\prec$ 是[[~/文档/note/离散数学/Disc_Math.org::MK185][偏序关系]]
...
（1） $P\subset\mathbb{N}$ 且 $|P|<\infty$ 是[[~/文档/note/离散数学/Disc_Math.org::MK42][有限集]]
...
则定义 $f'_1(\vec{x})=f'_2(\vec{x})$ 的充要条件是存在[[~/文档/note/离散数学/Disc_Math.org::MK200][双射]] $\phi:P'\to Q'$
...
以及定义 $P^*=\left\{I_i\big|i\in P\right\}$ 由于 $|P|<\infty$ 则显然 $|P^*|<\infty$ ，则显然可构建[[~/文档/note/离散数学/Disc_Math.org::MK195][单射]] $\phi:P^*\to\mathbb{N}$ 则定义 $P_0=\left\{\phi(p)\big|p\in P^*\right\}$
...
根据[[MK484][定理6]]可得存在[[MK390][代数封闭域]] $\mathcal{N}=\left<N,J\right>$ 是 $\mathcal{M}$ 的[[MK341][扩张域]]，又根据[[MK412][性质3]]可得 $N$ 是[[~/文档/note/离散数学/Disc_Math.org::MK43][无限集]]
...
根据[[MK447][相等]]可得存在[[~/文档/note/离散数学/Disc_Math.org::MK200][双射]] $\phi:P'\to Q'$
...
（2） 对于任意 $i\in P$ 有 $I_{i}=\left\{p\big|K'_p=K'_i\land\left(\forall j\in K_i\left(k_{i,j}=k_{p,j}\right)\right)\right\}$ ， $P^*=\left\{I_i\big|i\in P\right\}$ ，[[~/文档/note/离散数学/Disc_Math.org::MK195][单射]] $\phi:P^*\to\mathbb{N}$
...
任意[[MK338][域]] $\mathcal{M}=\left<M,I\right>$ 若 $M$ 是[[~/文档/note/离散数学/Disc_Math.org::MK43][无限集]]，有关于 $\vec{x}=\left<x_1,...,x_{n}\right>$ 的[[MK446][最简式]] $f(\vec{x})=\sum_{i\in P}\left(a_i\left(\prod_{j\in K_i}x_j^{k_{i,j}}\right)\right)\in M[\vec{x}]$
...
若[[MK378][次数]]大于 $0$ ，则根据[[MK410][推论]] $f(x_1)$ 至多有 $n$ 个[[MK389][根]]，由于 $M$ 是[[~/文档/note/离散数学/Disc_Math.org::MK43][无限集]]，故存在 $a\in M$ 不是 $f(x_1)$ 的[[MK389][根]]
...
（1） $\mathcal{M}{[\vec{x}]}=\left<M{[\vec{x}]},I{[\vec{x}]}\right>$ 是 $\mathcal{L}_{\mathcal{A}_\mathbb{F}}$ 下的[[~/文档/note/数理逻辑/sllj.org::MK153][结构]]
...
******** 是 $\mathcal{L}_{\mathcal{A}_\mathbb{F}}$ 下的[[~/文档/note/数理逻辑/sllj.org::MK153][结构]]

由于 $\mathcal{M}$ 是[[MK338][域]]故是 $\mathcal{L}_{\mathcal{A}_\mathbb{F}}$ 下的[[~/文档/note/数理逻辑/sllj.org::MK153][结构]]，则对于任意 $\{a_i,b_i\}\subset M$ 均有 $I(f_+)(a_i,b_i)\in M,I(f_\times)(a_i,b_i)\in M,I(f_-)(a_i)\in M$

故显然 $\mathcal{M}{[\vec{x}]}$ 对 $I{[\vec{x}]}(f_+),I{[\vec{x}]}(f_\times),I{[\vec{x}]}(f_-)$ 封闭，即为 $\mathcal{L}_{\mathcal{A}_\mathbb{F}}$ 下的[[~/文档/note/数理逻辑/sllj.org::MK153][结构]] 
...
显然 $\phi$ 是[[~/文档/note/离散数学/Disc_Math.org::MK194][函数]]且易证对于任意 $f_1(\vec{x})\ne f_2(\vec{x})$ 易证 $\phi(f_1(\vec{x}))\ne\phi(f_2(\vec{x}))$ 即 $\phi$ 是[[~/文档/note/离散数学/Disc_Math.org::MK195][单射]]

根据[[~/文档/note/离散数学/Disc_Math.org::MK27][等势]]有 $\left|\bigcup_{n\in\mathbb{N}}M[\vec{x}_n]\right|\leq\left|\bigcup_{n\in\mathbb{N}}\left(\mathbb{N}\times M\times\left(\bigcup_{n\in\mathbb{N}}(\mathbb{N}\times\mathbb{N})^n\right)\right)^n\right|$ 显然 $\left(\mathbb{N}\times M\times\left(\bigcup_{n\in\mathbb{N}}(\mathbb{N}\times\mathbb{N})^n\right)\right)^n$ 是[[~/文档/note/离散数学/Disc_Math.org::MK43][无限集]]

故根据[[~/文档/note/离散数学/Disc_Math.org::MK616][定理3]]可得 $\left|\bigcup_{n\in\mathbb{N}}\left(\mathbb{N}\times M\times\left(\bigcup_{n\in\mathbb{N}}(\mathbb{N}\times\mathbb{N})^n\right)\right)^n\right|=\max\left(\left\{\left|\left(\mathbb{N}\times M\times\left(\bigcup_{n\in\mathbb{N}}(\mathbb{N}\times\mathbb{N})^n\right)\right)^n\right|\big|n\in\mathbb{N}\right\}\right)$

显然 $\mathbb{N}\times M\times\left(\bigcup_{n\in\mathbb{N}}(\mathbb{N}\times\mathbb{N})^n\right)$ 是[[~/文档/note/离散数学/Disc_Math.org::MK43][无限集]]，根据[[~/文档/note/离散数学/Disc_Math.org::MK618][定理5]]易证对于任意 $n\in\mathbb{N}$ 均有 $\left|\left(\mathbb{N}\times M\times\left(\bigcup_{n\in\mathbb{N}}(\mathbb{N}\times\mathbb{N})^n\right)\right)^n\right|=\left|\mathbb{N}\times M\times\left(\bigcup_{n\in\mathbb{N}}(\mathbb{N}\times\mathbb{N})^n\right)\right|$

又根据[[~/文档/note/离散数学/Disc_Math.org::MK726][推论]]可得 $\left|\mathbb{N}\times M\times\left(\bigcup_{n\in\mathbb{N}}(\mathbb{N}\times\mathbb{N})^n\right)\right|=\max\left(|\mathbb{N}^n|,|M|,\left|\bigcup_{n\in\mathbb{N}}(\mathbb{N}\times\mathbb{N})^n\right|\right)$

同理结合[[~/文档/note/离散数学/Disc_Math.org::MK616][定理3]]以及[[~/文档/note/离散数学/Disc_Math.org::MK618][定理5]]可得 $\left|\bigcup_{n\in\mathbb{N}}(\mathbb{N}\times\mathbb{N})^n\right|=|\mathbb{N}^n|=|\mathbb{N}|$ 即有 $\left|\mathbb{N}\times M\times\left(\bigcup_{n\in\mathbb{N}}(\mathbb{N}\times\mathbb{N})^n\right)\right|=\max\left(|\mathbb{N}|,|M|\right)$
 
根据[[~/文档/note/离散数学/Disc_Math.org::MK28][等势等价]]可得 $\left|\bigcup_{n\in\mathbb{N}}\left(\mathbb{N}\times M\times\left(\bigcup_{n\in\mathbb{N}}(\mathbb{N}\times\mathbb{N})^n\right)\right)^n\right|=\max\left(|\mathbb{N}^n|,|M|\right)$ 根据[[~/文档/note/离散数学/Disc_Math.org::MK725][定理6]]有 $\left|\bigcup_{n\in\mathbb{N}}M[\vec{x}_n]\right|\leq\max\left(|\mathbb{N}|,|M|\right)$ 
...
根据[[~/文档/note/离散数学/Disc_Math.org::MK4][伯恩斯坦定理]] $\max\left(|\mathbb{N}|,|M|\right)=\left|\bigcup_{n\in\mathbb{N}}M[\vec{x}_n]\right|$
...
根据[[~/文档/note/离散数学/Disc_Math.org::MK27][等势]]有 $\left|M[\vec{x}_n]\right|\leq\left|\bigcup_{n\in\mathbb{N}}\left(\mathbb{N}\times M\times\left(\bigcup_{n\in\mathbb{N}}\mathbb{N}^n\right)\right)^n\right|$ 显然 $\left(\mathbb{N}\times M\times\left(\bigcup_{n\in\mathbb{N}}\mathbb{N}^n\right)\right)^n$ 是[[~/文档/note/离散数学/Disc_Math.org::MK43][无限集]]

故根据[[~/文档/note/离散数学/Disc_Math.org::MK616][定理3]]可得 $\left|\bigcup_{n\in\mathbb{N}}\left(\mathbb{N}\times M\times\left(\bigcup_{n\in\mathbb{N}}\mathbb{N}^n\right)\right)^n\right|=\max\left(\left\{\left|\left(\mathbb{N}\times M\times\left(\bigcup_{n\in\mathbb{N}}\mathbb{N}^n\right)\right)^n\right|\big|n\in\mathbb{N}\right\}\right)$

显然 $\mathbb{N}\times M\times\left(\bigcup_{n\in\mathbb{N}}\mathbb{N}^n\right)$ 是[[~/文档/note/离散数学/Disc_Math.org::MK43][无限集]]，根据[[~/文档/note/离散数学/Disc_Math.org::MK618][定理5]]易证对于任意 $n\in\mathbb{N}$ 均有 $\left|\left(\mathbb{N}\times M\times\left(\bigcup_{n\in\mathbb{N}}\mathbb{N}^n\right)\right)^n\right|=\left|\mathbb{N}\times M\times\left(\bigcup_{n\in\mathbb{N}}\mathbb{N}^n\right)\right|$

又根据[[~/文档/note/离散数学/Disc_Math.org::MK726][推论]]可得 $\left|\mathbb{N}\times M\times\left(\bigcup_{n\in\mathbb{N}}\mathbb{N}^n\right)\right|=\max\left(|\mathbb{N}^n|,|M|,\left|\bigcup_{n\in\mathbb{N}}\mathbb{N}^n\right|\right)$

同理结合[[~/文档/note/离散数学/Disc_Math.org::MK616][定理3]]以及[[~/文档/note/离散数学/Disc_Math.org::MK618][定理5]]可得 $\left|\bigcup_{n\in\mathbb{N}}\mathbb{N}^n\right|=|\mathbb{N}|$ 即有 $\left|\mathbb{N}\times M\times\left(\bigcup_{n\in\mathbb{N}}\mathbb{N}^n\right)\right|=\max\left(|\mathbb{N}|,|M|\right)$
 
根据[[~/文档/note/离散数学/Disc_Math.org::MK28][等势等价]]可得 $\left|\bigcup_{n\in\mathbb{N}}\left(\mathbb{N}\times M\times\left(\bigcup_{n\in\mathbb{N}}\mathbb{N}^n\right)\right)^n\right|=\max\left(|\mathbb{N}^n|,|M|\right)$ 根据[[~/文档/note/离散数学/Disc_Math.org::MK725][定理6]]有 $\left|M[\vec{x}_n]\right|\leq\max\left(|\mathbb{N}|,|M|\right)$ 

显然有 $|\mathbb{N}|\leq\left|M[\vec{x}_n]\right|,|M|\leq\left|M[\vec{x}_n]\right|$ 即亦有 $\max\left(|\mathbb{N}|,|M|\right)\leq\left|[\vec{x}_n]\right|$ 根据[[~/文档/note/离散数学/Disc_Math.org::MK4][伯恩斯坦定理]] $\max\left(|\mathbb{N}|,|M|\right)=\left|M[\vec{x}_n]\right|$
...
若 $\mathcal{M}=\left<M,I\right>$ 是[[MK338][域]] $\mathcal{M}[x]=\left<M[x],I[x]\right>$ 是其[[MK374][多项式环]]，任意 $\{f_1(x),...,f_n(x)\}\in M[x]$ 满足：
...
则根据[[MK522][唯一因式分解]]易证存在[[MK377][首一不可约]] $g'(x)$ 满足 $g(x)=g'(x)\cdot h(x)$ 则有 $f_1(x)=g'(x)\cdot (h(x)\cdot g_1(x))$

以及 $f_2(x)\cdot...\cdot f_n(x)=g'(x)\cdot (h(x)\cdot g_2(x))$

又根据[[MK521][性质1]]以及数学归纳法可得存在 $2\leq u\leq n$ 满足存在 $h'(x)\in M[x]$ 使得 $f_u(x)=h'(x)g'(x)$

由于 $g'(x)$ [[MK377][首一不可约]]，故可得 $\deg(g'(x))>0$ ，结合 $f_1(x)=g'(x)\cdot (h(x)\cdot g_1(x))$ 以及 $u\ne 1$
...
满足 $a$ 是 $f(x)$ 的[[MK389][根]]，则存在 $p(x)$ 满足 $f(x)=I[x](f_\times)(p(x),x+(-a))$
...
若 $\mathcal{M}=\left<M,I\right>$ 是[[MK338][域]] $\mathcal{M}[x]=\left<M[x],I[x]\right>$ 是其[[MK374][多项式环]]，对于任意 $\{f(x),g_1(x),g_2(x),h_1(x),h_2(x)\}\subset M[x]$ 若满足：
...
根据条件（2）以及[[MK384][性质8]]可得存在 $\{u(x),v(x)\}\subset M[x]$ 使得 $u(x)g_1(x)+v(x)g_2(x)=I[x](c_1)$
...
又根据[[MK383][性质7]]的唯一性可得 $h_1(x)=h^*(x)=(u(x)h_2(x)+v(x)h_1(x))g_2(x)$ 定义 $h'(x)=u(x)h_2(x)+v(x)h_1(x)$
...
任意 $\mathcal{L}_{\mathcal{A}_\mathbb{F}}$ 的[[~/文档/note/数理逻辑/sllj.org::MK153][结构]] $\mathcal{M}=\left<M,I\right>$ 满足[[MK337][公里（4）]]均有 $\mathcal{M}\vDash(\forall x_1(\exists x_2(f_+(x_1,x_2)\hat{=}c_0)))$
...
任意 $\mathcal{M}=\left<M,I\right>$ 是[[MK338][域]]则对于任意 $\{a,b\}\subset M$ 有 $I(f_-)(I(f_\times)(a,b))=I(f_\times)(I(f_-)(a),b)=I(f_\times)(a,I(f_-)(b))$
...
（5） 对于任意 $a\in N$ 根据[[~/文档/note/离散数学/Disc_Math.org::MK355][乘法幺元]]以及[[~/文档/note/数理逻辑/sllj.org::MK158][满足]]有 $J(f_\times)(J(c_1),a)=a$ 。由于是[[~/文档/note/数理逻辑/sllj.org::MK282][子结构]]，则有 $J(c_1)=I(c_1)$

     故可得 $J(c_1)=I(c_1)\in M$ 是 $\mathcal{M}$ 中的[[~/文档/note/离散数学/Disc_Math.org::MK355][乘法幺元]]

（6） 同上根据[[~/文档/note/离散数学/Disc_Math.org::MK355][乘法结合]]以及[[~/文档/note/数理逻辑/sllj.org::MK158][满足]]易证对于任意 $\{k,l\}\subset M, a\in N$ 均有 $J(f_\times)(J(f_\times)(k,l),a)=J(f_\times)(k,J(f_\times)(l,a))$
...
定义对于任意 $a\in M$ 有 $e(a)=[ax^0]_\sim$ ，即 $ax^0$ 为[[MK309][环]] $\mathcal{M}[x]$ 在其[[MK348][理想]] $(f(x))$ 上的[[MK352][同余关系]]的[[~/文档/note/离散数学/Disc_Math.org::MK177][等价类]]
...
故假设不成立，即 $a\not\sim b$ ，故有 $e(a)=[a]_\sim\ne[b]_\sim=e(b)$ 故 是[[~/文档/note/离散数学/Disc_Math.org::MK195][单射]]
...
显然 $f$ 是[[~/文档/note/离散数学/Disc_Math.org::MK200][双射]]，根据[[~/文档/note/离散数学/Disc_Math.org::MK203][求逆]]可得存在[[~/文档/note/离散数学/Disc_Math.org::MK203][逆函数]] $g^{-1}:N\to N'$ ，定义 $J'$ 满足：
...
进一步可得 $\mathcal{N}'=\left<N',J'\right>$ 是 $\mathcal{L}_{\mathcal{A}_\mathbb{F}}$ 上的[[~/文档/note/数理逻辑/sllj.org::MK153][结构]]，进一步易证 $\mathcal{N}',\mathcal{N}$ [[~/文档/note/数理逻辑/sllj.org::MK274][同构]]，即有：
...
定义 $M^*=\left\{[a]_\sim\big|a\in M\right\}$ 即 $M$ 中元素 $a$ 在 $M[x]/(f(x))$ 中的[[~/文档/note/离散数学/Disc_Math.org::MK177][等价类]]则：
...
根据[[MK369][定义]] $\sum_{i=0}^{n-1}[b_i]_\sim[x^i]_\sim=\left[I(c_0)\right]_\sim$ 由于 $e:M[x]/(p(x))\to M_{(\alpha)}$ 是[[~/文档/note/离散数学/Disc_Math.org::MK200][双射]]，故若有 $b_i\ne I(c_0)$ 则有 $[b_i]_\sim=e^{-1}(b_i)\ne e^{-1}(I(c_0))=\left[I(c_0)\right]_\sim$
...
即对于任意 $[f(x)]_\sim=[g(x)]_\sim$ 有 $e([f(x)]_\sim)=e([g(x)]_\sim)$ 故 $e$ 是[[~/文档/note/离散数学/Disc_Math.org::MK194][函数]]
...
则可推出以下矛盾，故假设不成立，即若有 $[f(x)]_\sim\ne[g(x)]_\sim$ 则有 $e([f(x)]_\sim)\ne e([g(x)]_\sim)$ 即 $e$ 是[[~/文档/note/离散数学/Disc_Math.org::MK195][单射]]
...
若 $r_0(x)=J(c_0)$ 则根据[[MK382][推论]]可得 $f(x)=g(x)$ 根据[[MK355][定理1]]可得[[MK352][同余关系]]是[[~/文档/note/离散数学/Disc_Math.org::MK176][等价关系]]，

根据[[~/文档/note/离散数学/Disc_Math.org::MK168][自反性]]有 $[f(x)]_\sim=[g(x)]_\sim$ 故矛盾，假设不成立。即有 $r_0(x)\ne J_0(c_0)$ ，即[[MK378][次数]]不为 $-1$
...
根据前几步证明可得 $e$ 是[[MK344][同态]]且是[[~/文档/note/离散数学/Disc_Math.org::MK195][单射]]可得 $e:M[x]/(p(x))\to M_{(\alpha)}$ 是 $\mathcal{N}$ 到 $\mathcal{M}_{(\alpha)}$ 的[[~/文档/note/数理逻辑/sllj.org::MK300][嵌入映射]]
...
故可得必有 $\mathcal{M}_{(\alpha)}=\mathcal{M}'_{(\alpha)}$ ，即有 $e:M[x]/(p(x))\to M_{(\alpha)}$ 是[[~/文档/note/离散数学/Disc_Math.org::MK200][双射]]，即 $\mathcal{M}_{(\alpha)}$ 与 $\mathcal{N}$ [[~/文档/note/数理逻辑/sllj.org::MK274][同构]]
...
若 $a_i\ne b_i$ 由于 $e$ 是[[~/文档/note/数理逻辑/sllj.org::MK274][同构映射]]，故亦为[[~/文档/note/离散数学/Disc_Math.org::MK200][双射]]，故可得 $e(a_i)\ne e(b_i)$ 则有 $\sum_{i=0}^ne(a_i)x^i\ne\sum_{i=0}^me(b_i)x^i$

综上所述 $e'$ 是[[~/文档/note/离散数学/Disc_Math.org::MK195][单射]]

******* 是[[~/文档/note/离散数学/Disc_Math.org::MK198][满射]]<<MK397>>

由于 $e$ 是[[~/文档/note/数理逻辑/sllj.org::MK274][同构映射]]，故亦为[[~/文档/note/离散数学/Disc_Math.org::MK200][双射]]，则根据[[~/文档/note/离散数学/Disc_Math.org::MK203][逆运算]]可得存在逆函数 $e^{-1}:N\to M$
...
根据[[~/文档/note/离散数学/Disc_Math.org::MK203][求逆]]可得存在逆函数 $e'^{-1}$ 根据[[~/文档/note/数理逻辑/sllj.org::MK275][引理1]]可得 $e'^{-1}$ 亦为[[~/文档/note/数理逻辑/sllj.org::MK274][同构函数]]
...
由于 $e:M\to N$ 是[[~/文档/note/数理逻辑/sllj.org::MK274][同构映射]]则根据[[MK472][性质3]]可得 $e(f(\vec{x}))$ 可以根[[MK446][最简式]]，故 $e'$ 是[[~/文档/note/离散数学/Disc_Math.org::MK194][函数]]

根据以下证明以及[[MK468][性质16]]可得 $e'$ 是 $\mathcal{M}[\vec{x}]$ 到 $\mathcal{N}[\vec{x}]$ 的[[~/文档/note/数理逻辑/sllj.org::MK274][同构映射]]

******* 是[[~/文档/note/离散数学/Disc_Math.org::MK194][函数]]

根据[[MK446][最简式]]对应的[[MK437][唯一性]]以及[[MK472][性质3]]可得 $e'$ 是[[~/文档/note/离散数学/Disc_Math.org::MK194][函数]]
...
根据[[MK447][条件]]若不存在[[~/文档/note/离散数学/Disc_Math.org::MK200][双射]] $\phi:P\to Q$ 满足对于任意存在 $i\in P$ 有 $K_i=L_{\phi(i)}$ 且对于任意 $i\in P,j\in K_i$ 有 $k_{i,j}=l_{\phi(i),j}$
...
由于 $e$ 是[[~/文档/note/数理逻辑/sllj.org::MK274][同构映射]]，故是[[~/文档/note/离散数学/Disc_Math.org::MK200][双射]]，则存在[[~/文档/note/离散数学/Disc_Math.org::MK203][逆函数]] $e^{-1}:N\to M$ 则对于任意 $f(\vec{x})=\sum_{i\in P}\left(b_i\left(\prod_{j\in K_i}x_j^{k_{i,j}}\right)\right)\in N[\vec{x}]$
...
定义[[~/文档/note/离散数学/Disc_Math.org::MK194][函数]] $e:\mathbb{Q}\to M$ 满足对于任意 $p\geq0,q>0$ 均有 $e\left(\frac{p}{q}\right)=I(f_\times)\left(\sum_{i=1}^p I(c_1),\left(\sum_{i=1}^q I(c_1)\right)^{-1}\right)$
...
综上所述，对于任意 $q_1\ne0,q_2\ne0,\{p_1,p_2,q_1,q_2\}\subset\mathbb{N}$ 若有 $\frac{p_1}{q_1}=\frac{p_2}{q_2}$ 则 $e\left(\frac{p_1}{q_1}\right)=e\left(\frac{p_2}{q_2}\right)$ 即是[[~/文档/note/离散数学/Disc_Math.org::MK194][函数]]

****** [[~/文档/note/离散数学/Disc_Math.org::MK195][单射]]
...
则与上一步同理易证 $e\left(\frac{p_1}{q_1}\right)\ne e\left(\frac{p_2}{q_2}\right)$ 即为[[~/文档/note/离散数学/Disc_Math.org::MK195][单射]]
...
（2） [[~/文档/note/数理逻辑/sllj.org::MK108][常元符号]] $c_0,c_1$

（3） [[~/文档/note/数理逻辑/sllj.org::MK10][谓词符号]] $p_<$

则有 $\mathcal{A}_{\mathbb{F}_<}=\{f_\times,f_+,f_-,c_0,c_1\}$ 进一步有 $\mathcal{L}_{\mathcal{A}_{\mathbb{F}_<}}$ 是环理论的[[~/文档/note/数理逻辑/sllj.org::MK151][语言]]

*** 公理

同[[MK337][域公理]]，外加以下四条

（1） 三歧性 $\phi_\text{tri}=(\forall x_1(\forall x_2(\phi_1\land\phi_2\land\phi_3)))$ 其中 $\phi_1,\phi_2,\phi_3$ 定义如下

     $\phi_1=((x_1\hat{=}x_2)\to((\lnot p_<(x_1,x_2))\land(\lnot p_<(x_2,x_1))))$

     $\phi_2=(p_<(x_1,x_2)\to((\lnot (x_1\hat{=}x_2))\land(\lnot p_<(x_2,x_2))))$

     $\phi_3=(p_<(x_2,x_1)\to((\lnot p_<(x_1,x_2))\land(\lnot (x_1\hat{=}x_2))))$
...
[[MK338][结构]] $\mathcal{M}=\left<M,I\right>$ 是 $\mathcal{L}_{\mathcal{A}_{\mathbb{F}_<}}$ 的[[~/文档/note/数理逻辑/sllj.org::MK153][结构]]，则其满足[[MK356][性质4]]以及：

（1)  $\mathcal{M}\vDash\phi_{\text{tri}}$ 的充要条件是对于任意 $\{a,b\}\subset M$ 三项 $a=b,\left<a,b\right>\in I(p_<),\left<b,a\right>\in I(p_<)$ 有且只有一项成立

（2） $\mathcal{M}\vDash(\forall x_1(\forall x_2(\forall x_3((p_<(x_1,x_2)\land p_<(x_2,x_3))\to p_<(x_1,x_3)))))$ 的充要条件是

     对于任意 $\{a,b,c\}\subset M$ 若有 $\left<a,b\right>\in I(p_<),\left<b,c\right>\in I(p_<)$ 则 $\left<a,c\right>\in I(p_<)$

（3） $\mathcal{M}\vDash(\forall x_1(\forall x_2(\forall x_3(p_<(x_1,x_2)\to p_<(f_+(x_1,x_3),f_+(x_2,x_3))))))$ 的充要条件是

     对于任意 $\{a,b,c\}\subset M$ 若有 $\left<a,b\right>\in I(p_<)$ 则 $\left<I(f_+)(a,c),I(f_+)(b,c)\right>\in I(p_<)$

（4） $\mathcal{M}\vDash(\forall x_1(\forall x_2(\forall x_3((p_<(x_1,x_2)\land p_<(c_0,x_3))\to p_<(f_\times(x_1,x_3),f_\times(x_2,x_3))))))$ 的充要条件是

     对于任意 $\{a,b,c\}\subset M$ 若有 $\left<a,b\right>\in I(p_<),\left<I(c_0),c\right>\in I(p_<)$ 则 $\left<I(f_\times)(a,c),I(f_\times)(b,c)\right>\in I(p_<)$
...
若 $\mathcal{M}=\left<M,I\right>$ 是[[MK526][有序域]]，则 $\mathcal{M}\vDash(\forall x_1(p_<(x_1,c_0)\to p_<(c_0,f_-(x_1))))$ 以及 $\mathcal{M}\vDash(\forall x_1(p_<(f_-(x_1),c_0)\to p_<(c_0,x_1)))$

***** 证明

定义 $<,+,-,0$ 分别代表 $I(p_<),I(f_+),I(f_-),I(c_0)$ 则任意 $a\subset M$ 若有 $a<0$ 则根据[[MK527][性质1]] $a+(-a)<0+(-a)$

同理根据[[MK527][性质1]]中加法逆元可得 $0<(-a)$ 即根据[[~/文档/note/数理逻辑/sllj.org::MK158][满足]]有 $\mathcal{M}\vDash(\forall x_1(p_<(x_1,c_0)\to p_<(c_0,f_-(x_1))))$ 

结合[[MK528][性质9]]同理易证 $\mathcal{M}\vDash(\forall x_1(p_<(f_-(x_1),c_0)\to p_<(c_0,x_1)))$

**** 性质3<<MK529>>

若 $\mathcal{M}=\left<M,I\right>$ 是[[MK526][有序域]]，则 $\mathcal{M}\vDash p_<(c_0,c_1)$ 

***** 证明

定义 $\times,<,+,-,0,1$ 分别代表 $I(f_\times),I(p_<),I(f_+),I(f_-),I(c_0),I(c_1)$ 根据[[MK527][性质1]]显然 $1\ne 0$ ，假设 $1<0$

则根据[[MK527][性质1]]中加法相容有 $1+(-1)<0+(-1)$ 即 $0<-1$ 进一步根据乘法相容可得 $0\times(-1)=(-1)\times(-1)$

根据[[MK440][性质15]]可得 $-(-1)=-(-(1\times 1))=-((-1)\times 1)=(-1)\times(-1)$ 又根据[[MK528][性质9]]可得 $-(-1)=1$

即有 $0<(-1)\times(-1)=1$ 显然与假设矛盾。故假设不成立，即 $1\not<0$

则根据[[MK527][性质1]]三歧性可得 $0<1$ 即 $\mathcal{M}\vDash p_<(c_0,c_1)$

**** 性质4

若 $\mathcal{M}=\left<M,I\right>$ 是[[MK526][有序域]]则其[[MK339][特征]] $p=0$

***** 证明

定义 $\times,<,+,-,0,1$ 分别代表 $I(f_\times),I(p_<),I(f_+),I(f_-),I(c_0),I(c_1)$ 假设 $p=n\ne0$ 则 $\sum_{i=1}^n1=0$

根据[[MK529][性质3]]可得 $0<1$ 则有 $0+1=1<2=1+1$ 又根据[[MK527][性质1]]的传递性有 $0<2$

以此类推可得 $0<n=\sum_{i=1}^n1$ 显然与[[MK527][性质1]]中三歧性矛盾，故假设不成立，即 $p=0$

**** 性质5<<MK531>>

若 $\mathcal{M}=\left<M,I\right>$ 是[[MK526][有序域]]则 $\mathcal{M}\vDash(\forall x_1((\lnot(x_1\hat{=}c_0))\to p_<(c_0,f_\times(x_1,x_1))))$

***** 证明

定义 $\times,<,+,-,0,1$ 分别代表 $I(f_\times),I(p_<),I(f_+),I(f_-),I(c_0),I(c_1)$ 对于任意 $a\in M$ 有 $a\ne 0$

若 $0<a$ 则根据[[MK527][性质1]]乘法相容直接可得 $0=0\times a<a\times a$

若有 $a<0$ 根据[[MK340][性质2]]有 $0<-a$ 则根据[[MK527][性质1]]中乘法相容可得 $a\times(-a)<0\times(-a)=0$

又根据[[MK440][性质15]]可得 $a\times(-a)=-(a\times a)<0$ 再根据[[MK528][性质2]]可得 $0<a\times a$ 

故无论那种情况均有 $0<a\times a$ 根据[[~/文档/note/数理逻辑/sllj.org::MK158][满足]]有 $\mathcal{M}\vDash(\forall x_1((\lnot(x_1\hat{=}c_0))\to p_<(c_0,f_\times(x_1,x_1))))$

**** 性质6

若 $\mathcal{M}=\left<M,I\right>$ 是[[MK526][有序域]]
...
则根据[[MK531][性质5]]对于任意 $\{a,b\}\subset M$ 均有 $0\leq(a+(-b))\times(a+(-b))$

则根据[[MK527][性质1]]中加法与 $<,=$ 以及运算法则，结合[[MK440][性质15]]易证
...
则对于任意 $\{a,b\}\subset M$ 若有 $a<b,0<a,0<b$ 则根据[[MK527][性质1]]乘法相容 $a\times a<b\times a,a\times b<b\times b$

则根据[[MK527][性质1]]的乘法交换以及传递性有 $a\times a<b\times b$
...
若 $\mathcal{M}=\left<M,I\right>$ 是[[MK390][代数封闭域]]则 $M$ 是[[~/文档/note/离散数学/Disc_Math.org::MK43][无限集]]

***** 证明

假设 $M=\{a_1,...,a_n\}$ 是[[~/文档/note/离散数学/Disc_Math.org::MK42][有限集]]，则定义[[~/文档/note/数理逻辑/sllj.org::MK129][表达式]] $\phi=f_+(\prod_{i=1}^{n}f_+(x_i,f_-(x_0)),c_1)$

易证 $\phi$ 存在[[~/文档/note/数理逻辑/sllj.org::MK396][等价]]的[[MK336][一元多项式]] $\psi$ ，对于任意 $\mathcal{M}$ 的[[~/文档/note/数理逻辑/sllj.org::MK154][赋值]]满足 $v(x_i)=a_i$ 由于是[[~/文档/note/离散数学/Disc_Math.org::MK42][有限集]]，则易证有 $\left<\mathcal{M},v\right>\vDash((f_+(x_j,x_0)\hat{=}c_0)$

则进一步易证 $\left<\mathcal{M},v\right>\vDash(f_+(\prod_{i=1}^{n}f_+(x_i,f_-(x_0)),c_1)\hat{ =}c_1)$ 根据[[MK411][公理]]可得 $\mathcal{M}\vDash(\lnot(c_1\hat{ =}c_0))$

即存在一个[[MK336][一元多项式]] $\phi$ 满足 $\mathcal{M}\vDash(\forall x_0(\lnot(\psi\hat{ =}c_0)))[a_1,...,a_n]$ 与[[MK411][公理]]矛盾，故假设不成立，即 $M$ 是[[~/文档/note/离散数学/Disc_Math.org::MK43][无限集]]
...
根据[[~/文档/note/离散数学/Disc_Math.org::MK10][选择公理]]可得存在选择函数满足 $\psi(U_a)\in U_a$ 则对于任意 $a$ 定义 $\phi(a)=\psi(U_a)$ 以及 $\vec{x}_n=\left<x_1,...,x_n\right>,\vec{y}_m=\left<y_1,...,y_m\right>$

显然 $\phi$ 是 $M'_{(S)}$ 到 $\left(\bigcup_{n\in\mathbb{N}}\left(M'[\vec{x}_n]\times S^n\right)\right)\times\left(\bigcup_{m\in\mathbb{N}}\left(M'[\vec{y}_m]\times S^m\right)\right)$ 的[[~/文档/note/离散数学/Disc_Math.org::MK194][函数]]，对于任意 $a\ne b$ 且 $\{a,b\}\subset M'$

假设 $\phi(a)=\phi(b)$ 则有 $a=f(s_1,...,s_n)\left(g(y_1,...,y_m)\right)^{-1}=b$ 显然矛盾，故假设不成立。即 $a\ne b$ 必有 $\phi(a)\ne\phi(b)$

即 $\phi$ 是[[~/文档/note/离散数学/Disc_Math.org::MK195][单射]]。故可得 $\left|M'_{(S)}\right|\leq\left|\left(\bigcup_{n\in\mathbb{N}}\left(M'[\vec{x}_n]\times S^n\right)\right)\times\left(\bigcup_{m\in\mathbb{N}}\left(M'[\vec{y}_m]\times S^m\right)\right)\right|$ 显然易证 $\left|\left(\bigcup_{n\in\mathbb{N}}\left(M'[\vec{x}_n]\times S^n\right)\right)\right|=\left|\left(\bigcup_{m\in\mathbb{N}}\left(M'[\vec{y}_m]\times S^m\right)\right)\right|$

根据[[~/文档/note/离散数学/Disc_Math.org::MK726][推论]]可得 $\left|\left(\bigcup_{n\in\mathbb{N}}\left(M'[\vec{x}_n]\times S^n\right)\right)\times\left(\bigcup_{m\in\mathbb{N}}\left(M'[\vec{y}_m]\times S^m\right)\right)\right|=\left|\left(\bigcup_{n\in\mathbb{N}}\left(M'[\vec{x}_n]\times S^n\right)\right)\right|$

根据[[MK485][性质2]]可得对于任意 $n\in\mathbb{N}$ 有 $|M'[\vec{x}_n]|=\max(|M'|,|\mathbb{N}|)$ 由于 $\mathcal{M}'$ 与[[MK417][ $\mathbb{Z}_p$ ]]或 $\mathcal{Q}$ 有[[~/文档/note/数理逻辑/sllj.org::MK274][同构]]，故存在[[~/文档/note/离散数学/Disc_Math.org::MK200][双射]] $e:M'\to Z_p$ 或 $e:M'\to\mathbb{Q}$

结合[[~/文档/note/离散数学/Disc_Math.org::MK325][推论]]以及[[~/文档/note/离散数学/Disc_Math.org::MK27][等势]]可得 $|M'|\leq|\mathbb{N}|$ 即有 $|M'[\vec{x}_n]|=|\mathbb{N}|$ ，又根据[[~/文档/note/离散数学/Disc_Math.org::MK726][推论]]以及[[~/文档/note/离散数学/Disc_Math.org::MK28][等价性]]可得对于任意 $n\in\mathbb{N}$ 均有 $\left|M'[\vec{x}_n]\times S^n\right|=\max\left(|\mathbb{N}|,|S|\right)$

显然 $M'[\vec{x}_n]\times S^n$ 是[[~/文档/note/离散数学/Disc_Math.org::MK43][无限集]]，则根据[[~/文档/note/离散数学/Disc_Math.org::MK616][定理3]]可得 $\left|\left(\bigcup_{n\in\mathbb{N}}\left(M'[\vec{x}_n]\times S^n\right)\right)\right|=\max(|\mathbb{N}|,|S|)$ 最终可得 $\left|M'_{(S)}\right|\leq\max(|\mathbb{N}|,|S|)$ 

****** 证明（2）

根据结论（1）可得 $\left|M'_{(S)}\right|\leq|S|$ 显然有 $S\subset M_{(S)}$ 则根据[[~/文档/note/离散数学/Disc_Math.org::MK355][定理5]]可得 $|S|\leq\left|M'_{(S)}\right|$ 根据[[~/文档/note/离散数学/Disc_Math.org::MK4][伯恩斯坦定理]]有 $|S|=\left|M'_{(S)}\right|$

根据[[MK477][性质1]]可得 $\mathcal{M}$ 是 $\mathcal{M}'_{(S)}$ 的[[MK451][代数扩张]]，由于 $|\mathbb{N}|\leq |S|$ 故 $S$ 是[[~/文档/note/离散数学/Disc_Math.org::MK43][无限集]]，进一步易证 $M'_{(S)}$ 亦为[[~/文档/note/离散数学/Disc_Math.org::MK43][无限集]]

则根据[[MK486][定理4]]可得 $|M|=|M_{(S)}|$ 根据[[~/文档/note/离散数学/Disc_Math.org::MK28][等价性]]有 $|M|=|S|$ 
...
****** $\phi$ 是[[~/文档/note/离散数学/Disc_Math.org::MK200][双射]]
...
根据[[MK448][性质11]]可得 $a=b_1,a=b_2$ 即可得 $b_1=b_2$ ，即 $\phi$ 是[[~/文档/note/离散数学/Disc_Math.org::MK194][函数]]
...
故假设不成立，即不存在 $\{a,b\}\subset N$ 且 $a\ne b$ 使得 $\phi(a)=\phi(b)$ ，故是[[~/文档/note/离散数学/Disc_Math.org::MK195][单射]]

******* 是[[~/文档/note/离散数学/Disc_Math.org::MK198][满射]]

对于任意 $a\in M$ 有 $f(x)=x-a\in M[x]$ 又由于 $\mathcal{N}$ 是 $\mathcal{M}$ 的[[MK451][代数扩张]]，故可得 $a\in N$ 则 $f(a)=J(c_0)$

即有 $\left<a,a\right>\in\phi$ ，即对于任意 $a\in M$ 均有 $a\in N$ 使得 $\phi(a)=a$ 即是[[~/文档/note/离散数学/Disc_Math.org::MK198][满射]]
...
对于任意 $a\in N$ 由于 $\phi$ 是[[~/文档/note/离散数学/Disc_Math.org::MK200][双射]]，则根据 $\phi$ 定义有 $J(f_+)(a,J(f_-)(\phi(a)))=J(c_0)$ 根据[[MK448][性质11]] $\phi(a)=a$
...
（1） 若 $M$ [[~/文档/note/离散数学/Disc_Math.org::MK44][可数]]，则[[MK432][ $\mathcal{M}$ 的基]]为[[~/文档/note/离散数学/Disc_Math.org::MK48][至多可数集]]

（2） 若 $M$ [[~/文档/note/离散数学/Disc_Math.org::MK324][不可数]]，则[[MK432][ $\mathcal{M}$ 的基]]与 $M$ [[~/文档/note/离散数学/Disc_Math.org::MK27][等势]]
...
根据[[MK432][定义]]可得 $\mathcal{M}$ 的基 $B$ 属于 $M$ 故根据[[~/文档/note/离散数学/Disc_Math.org::MK355][定理5]]可得 $|B|\leq |M|$ ，故若 $|M|=|\mathbb{N}|$ 则根据[[~/文档/note/离散数学/Disc_Math.org::MK725][定理6]]可得 $|B|\leq|\mathbb{N}|$ 即（1）成立
...
则易证必有 $\phi(a_1)\cap\phi(a_2)=\varnothing$ 。定义 $\Phi=\left\{\phi(a)\big|a\in M\right\}$ 则根据[[~/文档/note/离散数学/Disc_Math.org::MK10][选择公理]]可得存在选择函数满足 $f(\phi(a))\in\phi(a)$

定义 $\psi(a)=f(\phi(a))$ 显然 $\psi:M\to B^*$ 是[[~/文档/note/离散数学/Disc_Math.org::MK194][函数]]，且由于对于任意 $\{a_1,a_2\}\subset M,a_1\ne a_2$ 有 $\phi(a_1)\cap\phi(a_2)=\varnothing$

则必有 $\psi(a_1)\ne\psi(a_2)$ 即 $\psi$ 是[[~/文档/note/离散数学/Disc_Math.org::MK195][单射]]，故根据[[~/文档/note/离散数学/Disc_Math.org::MK27][定义]]可得 $|M|\leq|B^*|$

假设 $|B|<|M|$ ，由于[[MK339][特征]] $p=0$ ，则根据[[MK432][定义]]可得 $\mathcal{N}'_p$ 与 $\mathcal{Q}$ [[~/文档/note/数理逻辑/sllj.org::MK274][同构]]，则显然有 $|N'_p|=|\mathbb{Q}|$ 又根据[[~/文档/note/离散数学/Disc_Math.org::MK325][推论1]]以及[[~/文档/note/离散数学/Disc_Math.org::MK28][传递性]]可得 $|N'_p|=|\mathbb{N}|$ 

则根据[[~/文档/note/离散数学/Disc_Math.org::MK726][推论]]可得 $\left|N'_p\times B\right|=\max(|\mathbb{N}|,|B|)$ 即 $N'_p\times B$ 必为[[~/文档/note/离散数学/Disc_Math.org::MK43][无限集]]，则根据[[~/文档/note/离散数学/Disc_Math.org::MK618][定理5]]可得对于任意 $n\in\mathbb{N}$ 可得 $\left|\left(N'_p\times B\right)^n\right|=\left|N'_p\times B\right|$

又[[~/文档/note/离散数学/Disc_Math.org::MK616][定理3]]可得 $|B^*|=\left|\bigcup_{n\in\mathbb{N}}\left(N'_p\times B\right)^n\right|=\left|N'_p\times B\right|=\max(|\mathbb{N}|,|B|)$ 。由于 $M$ [[~/文档/note/离散数学/Disc_Math.org::MK324][不可数]]即可得 $|M|>|\mathbb{N}|$ 结合假设有 $|M|>\max(|\mathbb{N}|,|B|)=|B^*|$

根据[[~/文档/note/离散数学/Disc_Math.org::MK727][定理4]]可得与 $|M|\leq|B^*|$ 矛盾，故假设不成立。即有 $|B|\geq|M|$

又显然 $B\subset M$ 故根据[[~/文档/note/离散数学/Disc_Math.org::MK355][定理5]]可得 $|B|\leq |M|$ 。最终根据[[~/文档/note/离散数学/Disc_Math.org::MK4][伯恩斯坦定理]]可得 $|B|=|M|$ 

***** 性质2

[[MK390][代数封闭域]] $\mathcal{M}=\left<M,I\right>$ 的[[MK339][特征]] $p\ne0$ ，则[[MK432][ $\mathcal{M}$ 的基]]与 $M$ [[~/文档/note/离散数学/Disc_Math.org::MK27][等势]]
...
又根据[[MK410][定理]]易证对于任意 $\tau_{g_{ij}}(x_0)$ 在 $N$ 中[[~/文档/note/数理逻辑/sllj.org::MK158][满足]] $\mathcal{N}\vDash(\lnot(\tau_{g_{ij}}(x_0)\hat{=}c_0})[b,e(a_1),...e(a_n)]$ 的 $b$ 为[[~/文档/note/离散数学/Disc_Math.org::MK42][有限]]个

[[~/文档/note/数理逻辑/sllj.org::MK158][满足]] $\mathcal{N}\vDash(\lnot(\tau_{g_{ij}}(x_0)\hat{=}c_0})[b,e(a_1),...e(a_n)]$ 的元素为 $B_j =\{b_{j,1},...,b_{j,n_j}\}$ 则显然 $B =\bigcup_{j=1}^m B_j$ 亦为[[~/文档/note/离散数学/Disc_Math.org::MK42][有限集]]

根据[[MK412][性质4]]可得 $N$ 为[[~/文档/note/离散数学/Disc_Math.org::MK43][无限集]]，故可得 $N-B\ne\varnothing$ 即存在 $\beta\in N$ 满足 $\beta\not\in B$
...
故可得 $e(i)=t_i\ne t_j=e(j)$ 即是[[~/文档/note/离散数学/Disc_Math.org::MK195][单射]]
...
则若 $\mathcal{M}$ 关于 $\mathcal{M}'$ 的[[MK438][超越基]] $S$ 与 $\mathcal{N}$ 关于 $\mathcal{N}'$ 的[[MK438][超越基]] $T$ [[~/文档/note/离散数学/Disc_Math.org::MK27][等势]]的充要条件是 $\mathcal{M},\mathcal{N}$ [[~/文档/note/数理逻辑/sllj.org::MK274][同构]]
...
则根据[[MK476][定理2]]可得 $\mathcal{M}'_{(S)},\mathcal{N}'_{(T)}$ [[~/文档/note/数理逻辑/sllj.org::MK274][同构]]，且根据[[~/文档/note/离散数学/Disc_Math.org::MK12][性质1]]可得 $\mathcal{M},\mathcal{N}$ 分别是 $\mathcal{M}'_{(S)},\mathcal{N}'_{(T)}$ 上的[[MK451][代数扩张]]
...
显然 $|T|=|e(T)|$ ，由于 $|S|<|T|$ 根据[[~/文档/note/离散数学/Disc_Math.org::MK361][定理7]]可得 $|S|<|e(T)|$ 根据[[MK505][推论]]可得 $e(T)$ 在 $\mathcal{M}$ 上[[MK445][代数相关]]，即存在：
...
同[[MK488][定理5]]中符号定义，若 $\mathcal{M}$ 关于 $\mathcal{M}'$ 的[[MK438][超越基]] $S$ ， $\mathcal{N}$ 关于 $\mathcal{N}'$ 的[[MK438][超越基]] $T$ 均为[[~/文档/note/离散数学/Disc_Math.org::MK43][无限集]]

则若 $|N|=|M|$ 则有 $\mathcal{M},\mathcal{N}$ [[~/文档/note/数理逻辑/sllj.org::MK274][同构]]

****** 证明

由于[[MK339][特征]]均为 $p$ 且 $S$ 为[[~/文档/note/离散数学/Disc_Math.org::MK43][无限集]]，则根据[[MK487][性质4]]可得 $|S|=|M|$ 同理可证 $|T|=|N|$ 根据[[~/文档/note/离散数学/Disc_Math.org::MK28][等价性]]可得 $|S|=|T|$
...
又根据 $|M|=|N|$ 则根据[[~/文档/note/离散数学/Disc_Math.org::MK28][等价性]]可得 $|S|=|T|$ ，即根据[[MK488][定理5]]可得 $\mathcal{M},\mathcal{N}$ [[~/文档/note/数理逻辑/sllj.org::MK274][同构]]
...
根据[[MK412][性质3]]可得 $\mathcal{T}_{ACF_p}$ 仅有[[~/文档/note/数理逻辑/sllj.org::MK221][无限模型]]，任取[[~/文档/note/离散数学/Disc_Math.org::MK3][基数]] $|\mathbb{N}|<\kappa$ ，则根据[[MK494][推论2]]可得 $\mathcal{T}_{ACF_p}$ 是一个 $\kappa$ [[~/文档/note/数理逻辑/sllj.org::MK437][等势同构]]理论
...
定义 $K$ 是 $\mathcal{L}_{\mathcal{A}_\mathbb{F}}$ 上的[[~/文档/note/数理逻辑/sllj.org::MK153][结构]]且为 $\mathcal{M}$ 的[[MK451][代数扩张域]]的集合，定义[[~/文档/note/离散数学/Disc_Math.org::MK155][关系]] $\prec$ 满足对于任意 $\{\mathcal{N}_1,\mathcal{N}_2\}\subset K$

有 $\mathcal{N}_1\prec\mathcal{N}_2$ 的充要条件是 $\mathcal{N}_2$ 是 $\mathcal{N}_1$ 的[[MK451][代数扩张]]

由于任意 $\mathcal{O}\in K$ 均为[[MK338][域]]，故则根据[[MK483][偏序性]]易证 $\left<K,\prec\right>$ 是[[~/文档/note/离散数学/Disc_Math.org::MK185][偏序集]]（显然自身是自身的[[MK451][代数扩张]]）

****** $\left<K,\prec\right>$ 上任意[[~/文档/note/离散数学/Disc_Math.org::MK386][链]]都有[[~/文档/note/离散数学/Disc_Math.org::MK326][上界]]

对于任意 $\left<K,\prec\right>$ 上的[[~/文档/note/离散数学/Disc_Math.org::MK386][链]] $T\subset K$ 根据以下证明可得存在 $\mathcal{M}_T$ 满足任意 $\mathcal{O}\in T$ 均为 $\mathcal{M}_T$ 的[[MK341][子域]]

即 $\mathcal{M}_T$ 是 $T$ 上关于 $\prec$ 的[[~/文档/note/离散数学/Disc_Math.org::MK326][上界]]
...
（2） 对于任意 $\{a_1,a_2\}\subset M_T$ 根据 $M_T$ 定义必有 $\{\mathcal{O}_1=\left<O_1,L_1\right>,\mathcal{O}_2=\left<O_2,L_2\right>\}\subset K$ 满足 $a_1\in O_1,a_2\in O_2$
     ...
     由于是[[~/文档/note/离散数学/Disc_Math.org::MK386][链]]，故不妨设 $\mathcal{O}_1\prec\mathcal{O}_2$ ，则有 $\{a_1,a_2\}\subset O_2$
...
则易证 $\mathcal{M}_T=\left<M_T,I_T\right>$ 是 $\mathcal{L}_{\mathcal{A}_\mathbb{F}}$ 上的[[~/文档/note/数理逻辑/sllj.org::MK153][结构]]，又根据 $L_T$ 定义可得任意 $\mathcal{O}\in T$ 均为 $\mathcal{M}_T$ 的[[~/文档/note/数理逻辑/sllj.org::MK282][子结构]]
...
满足 $a_1\in O_1,a_2\in O_2$ 由于是[[~/文档/note/离散数学/Disc_Math.org::MK386][链]]，故不妨设 $\mathcal{O}_1\prec\mathcal{O}_2$ ，显然 $\mathcal{O}_2$ 是[[MK338][域]]
...
根据上述证明以及[[~/文档/note/离散数学/Disc_Math.org::MK390][佐恩引理]]，可得 $\left<K,\prec\right>$ 上存在[[~/文档/note/离散数学/Disc_Math.org::MK186][极大元]] $\mathcal{N}=\left<N,J\right>$ 由于 $\mathcal{N}\in K$ 故为 $\mathcal{M}$ 的[[MK451][代数扩张]]
...
可得 $\mathcal{N}'$ 亦为 $\mathcal{M}$ 的[[MK451][代数扩张]]，即有 $\mathcal{N}'\in K$ 且 $\mathcal{N}\prec\mathcal{N}'$ 。与 $\mathcal{N}$ 是 $\left<K,\prec\right>$ 上存在[[~/文档/note/离散数学/Disc_Math.org::MK186][极大元]]矛盾

故假设不成立，即 $\mathcal{N}=\left<N,J\right>$ 是[[MK390][代数封闭域]]

**** 定理7

对于任意[[MK390][代数封闭域]] $\mathcal{M}=\left<M,I\right>$ [[MK339][特征]]为 $p$ ，满足 $M$ 是[[~/文档/note/离散数学/Disc_Math.org::MK44][可数集]]则 $\mathcal{M}$ 是[[~/文档/note/数理逻辑/sllj.org::MK394][饱和模型]]的充要条件是其[[MK496][超越基]] $S$ 满足 $|S|=|\mathbb{N}|$
...
对于任意 $X\subset M$ 满足 $|X|<|M|$ 由于 $|M|=|\mathbb{N}|$ 故可得 $X$ 是[[~/文档/note/离散数学/Disc_Math.org::MK42][有限集]]
...
（3） $\mathcal{N}_X=\left<N,J_X\right>$ [[~/文档/note/离散数学/Disc_Math.org::MK374][实现]] $\Gamma$
...
则 $v$ 是 $\mathcal{N}'_X$ 的[[~/文档/note/数理逻辑/sllj.org::MK154][赋值]]，根据[[~/文档/note/数理逻辑/sllj.org::MK287][同质子结构]]可得 $\left<\mathcal{N}'_X,v\right>\vDash\Gamma$ 根据[[~/文档/note/数理逻辑/sllj.org::MK275][引理]]可得存在[[~/文档/note/离散数学/Disc_Math.org::MK203][逆函数]] $e^{-1}:N'\to M$
...
根据[[MK487][性质4]] $\mathcal{M}^*_{(X)}$ 存在[[MK496][超越基]] $S_X$ 由于 $X$ 是[[~/文档/note/离散数学/Disc_Math.org::MK42][有限集]]，则 $S_X$ 亦为[[~/文档/note/离散数学/Disc_Math.org::MK42][有限集]]。结合 $|S|=|\mathbb{N}|$ 可得存在 $b\in S$ 满足 $b\not\in S_X$
...
根据[[~/文档/note/数理逻辑/sllj.org::MK275][引理]]可得存在 $e^{**}$ 的[[~/文档/note/离散数学/Disc_Math.org::MK203][逆函数]] $\left(e^{ * *}\right)^{-1}$ 为逆[[~/文档/note/数理逻辑/sllj.org::MK274][同构映射]]，根据[[~/文档/note/数理逻辑/sllj.org::MK276][定理1]]可得 $\left<\mathcal{M}_{\left(X\cup\{a\}\right)},v\cdot \left(e^{ * *}\right)^{-1}\right>\vDash\Gamma$
...
（1） [[MK496][超越度]]为[[~/文档/note/离散数学/Disc_Math.org::MK42][有限]]，设 $T=\{t_1,...,t_n\}$ 是[[MK496][超越基]]

（2） [[MK339][特征]]为 $p$ 的[[MK390][代数封闭域]]

假设 $\mathcal{N}$ 是[[~/文档/note/数理逻辑/sllj.org::MK394][饱和模型]]

任取若 $\mathcal{M}$ 是[[MK496][超越度]]为[[~/文档/note/离散数学/Disc_Math.org::MK44][可数]]的[[MK390][代数封闭域]]，其[[MK496][超越基]]为 $S$ ，则根据[[MK500][之前证明]]可得 $\mathcal{M}$ 是[[~/文档/note/数理逻辑/sllj.org::MK394][饱和模型]]，
...
（1） 有[[~/文档/note/离散数学/Disc_Math.org::MK44][可数]]个不[[~/文档/note/数理逻辑/sllj.org::MK274][同构]]的[[~/文档/note/数理逻辑/sllj.org::MK221][可数模型]] $\mathcal{M}_i=\left<M_i,I_i\right>,i\in\mathbb{N}$
...
根据[[MK487][性质4]]可得若 $\mathcal{M}$ 是 $\mathcal{T}_{\test{ACF}_p}$ 的[[~/文档/note/数理逻辑/sllj.org::MK221][可数模型]]，则其[[MK496][超越基]]必为[[~/文档/note/离散数学/Disc_Math.org::MK44][可数]]

根据[[MK488][定理5]]可得任意两个 $\mathcal{T}_{\test{ACF}_p}$ 的[[~/文档/note/数理逻辑/sllj.org::MK221][可数模型]]，[[~/文档/note/数理逻辑/sllj.org::MK274][同构]]的充要条件是[[MK496][超越基]]有[[~/文档/note/离散数学/Disc_Math.org::MK27][等势]]

由于[[MK496][超越基]] $|S|\leq|\mathbb{N}|$ 故有且仅有[[~/文档/note/离散数学/Disc_Math.org::MK44][可数]]种可能性，故有且仅有[[~/文档/note/离散数学/Disc_Math.org::MK44][可数]]个不[[~/文档/note/数理逻辑/sllj.org::MK274][同构]]的[[~/文档/note/数理逻辑/sllj.org::MK221][可数模型]]
...
则根据[[~/文档/note/离散数学/Disc_Math.org::MK27][等势]]存在 $S'_j\subset S_j$ 满足 $|S'_j|=|S_i|$ 则定义 $\mathcal{M}'_j$ 是[[MK496][超越基]]为 $|S'_j|$ 的 $\mathcal{T}_{\test{ACF}_p}$ [[~/文档/note/数理逻辑/sllj.org::MK221][可数模型]]
...
显然 $\mathcal{M}_\infty$ 是[[MK496][超越基]]为[[~/文档/note/离散数学/Disc_Math.org::MK44][可数集]]的 $\mathcal{T}_{\test{ACF}_p}$ [[~/文档/note/数理逻辑/sllj.org::MK221][可数模型]]，即对于任意 $i\in\mathbb{N}\cup{\infty}$ 有 $|S_i|\leq |S_\infty|$
...
若 $\mathcal{M}=\left<M,I\right>$ 是[[MK338][域]]，且 $M$ 是[[~/文档/note/离散数学/Disc_Math.org::MK42][有限集]]，根据[[MK484][定理6]]可得存在 $\mathcal{N}=\left<N,J\right>$ 满足：
...
若 $P$ 是[[~/文档/note/离散数学/Disc_Math.org::MK195][单射]]，可得 $P$ 是[[~/文档/note/离散数学/Disc_Math.org::MK198][满射]]
...
由于对于任意 $l\in\{1,...,n\}$ 均有 $|P_l|<\infty$ 故可得 $|S_b|<\infty$ 亦为[[~/文档/note/离散数学/Disc_Math.org::MK42][有限集]]，定义 $\mathcal{M}_{(S_b)}=\left<M_{(S_b)},I_{(S_b)}\right>$ 是 $S_b$ 在 $\mathcal{M}$ 上的[[MK393][生成扩张]]
...
由于 $S_b\subset N$ 则根据[[MK514][定理5]]可得 $\mathcal{M}_{(S_b)}$ 是 $\mathcal{N}$ 的[[MK341][子域]]，则易证 $P_{|M_{(S_b)}}$ 亦为[[~/文档/note/离散数学/Disc_Math.org::MK195][单射]]

由于 $|M_{(S_b)}|<\infty$ 故可得 $|\left(M_{(S_b)}\right)^n|<\infty$ 故 $P_{|M_{(S_b)}}$ 是[[~/文档/note/离散数学/Disc_Math.org::MK42][有限集]]上的自我映射，显然 $P_{|M_{(S_b)}}$ 必为[[~/文档/note/离散数学/Disc_Math.org::MK198][满射]]
...
综上所述，对于任意 $\vec{b}\in N^n$ 均存在 $\vec{a}\in N^n$ 使得 $P(\vec{a})=\vec{b}$ ，即 $P$ 是[[~/文档/note/离散数学/Disc_Math.org::MK198][满射]]
...
任取给定的 $P$ 以及 $\left<f_1(\vec{x}),...,f_n(\vec{x})\right>\in \mathbb{C}[\vec{x}]$ ，根据以下证明可得 $P$ 是[[~/文档/note/离散数学/Disc_Math.org::MK195][单射]]，可得 $P$ 是[[~/文档/note/离散数学/Disc_Math.org::MK198][满射]]

****** 公理化 $\varphi$ 

若 $P$ 是[[~/文档/note/离散数学/Disc_Math.org::MK195][单射]]，则对于任意 $\{\vec{a},\vec{b}\}\subset\mathbb{C}^n$ 均有 $P(\vec{a})=P(\vec{b})$ 当且仅当 $\vec{a}=\vec{b}$ 设 $f_l(\vec{x})=\sum_{i\in P_l}\left(a_{i,l}\left(\prod_{j\in K_{i,l}}x_j^{k_{i,j,l}}\right)\right)$
...
（2） $\eta:\mathbb{N}\times\mathbb{N}\to\mathbb{N}$ 是[[~/文档/note/离散数学/Disc_Math.org::MK195][单射]]，且 $m=\max\left(\left\{\phi(i,l)\big|i\in P_l\right\}\right)$

则

（1） 定义 $\phi=\left(\forall x_1...\forall x_n\forall y_1...\forall y_n\left(\bigwedge_{l=1}^n(f_l(\vec{x})\hat{=}f_l(\vec{y}))\right)\leftrightarrow\left(\bigwedge_{j=1}^n(x_j\hat{ =}y_j)\right)$ 描述是[[~/文档/note/离散数学/Disc_Math.org::MK195][单射]]

（2） 定义 $z_1,...,z_n$ 为与 $\alpha_{\eta(i,l)},x_j,y_j$ 不同的[[~/文档/note/数理逻辑/sllj.org::MK107][变元符号]] $\psi=\left(\forall z_1...\forall z_n\exists x_1...\exists x_n\left(\bigwedge_{l=1}^n(f_l(\vec{x})=z_l)\right)\right)$ 描述是[[~/文档/note/离散数学/Disc_Math.org::MK198][满射]]
...
（2） 若 $\mathcal{C}\vDash\varphi$ 则说明对于任意 $P':\mathbb{C}^n\to \mathbb{C}^n$ 若满足：
     ...
     则有若 $P'$ 是[[~/文档/note/离散数学/Disc_Math.org::MK195][单射]]，可得 $P'$ 是[[~/文档/note/离散数学/Disc_Math.org::MK198][满射]]。则根据[[~/文档/note/数理逻辑/sllj.org::MK158][满足]]可得对于 $P$ 亦成立
...
又根据上一步证明中 $\mathcal{C}\vDash\varphi$ 的阐述可得若 $P$ 是[[~/文档/note/离散数学/Disc_Math.org::MK195][单射]]，可得 $P$ 是[[~/文档/note/离散数学/Disc_Math.org::MK198][满射]]
