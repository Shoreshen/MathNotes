...
则有 $\mathcal{A}_{\mathbb{F}_<}=\{f_\times,f_+,f_-,c_0,c_1\}$ 进一步有 $\mathcal{L}_{\mathcal{A}_{\mathcbb{F}_<}}$ 是环理论的[[~/文档/note/数理逻辑/sllj.org::MK151][语言]]
...
[[MK338][结构]] $\mathcal{M}=\left<M,I\right>$ 是 $\mathcal{L}_{\mathcal{A}_{\mathcbb{F}_<}}$ 的[[~/文档/note/数理逻辑/sllj.org::MK153][结构]]，则其满足[[MK356][性质4]]以及：
...
定义 $K$ 是 $\mathcal{L}_{\mathcal{A}_\mathcbb{F}}$ 上的[[~/文档/note/数理逻辑/sllj.org::MK153][结构]]且为 $\mathcal{M}$ 的[[MK451][代数扩张域]]的集合，定义[[~/文档/note/离散数学/Disc_Math.org::MK155][关系]] $\prec$ 满足对于任意 $\{\mathcal{N}_1,\mathcal{N}_2\}\subset K$
