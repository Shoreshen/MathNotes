...
根据[[~/文档/note/数学分析/Chap7Note.org][乘积可积]]可得 $f(x)^2,g(x)^2,f(x)g(x)$ 均在 $[a,b]$ 上可积
...
且根据[[~/文档/note/数学分析/Chap7Note.org][乘积可积]]得 $\phi(x)\sin(px)$ 亦可积
...
则根据[[~/文档/note/数学分析/Chap7Note.org::MK5][线性]]，[[~/文档/note/数学分析/Chap7Note.org][绝对可积]]，[[~/文档/note/数学分析/Chap7Note.org][乘积可积]]以及[[~/文档/note/数学分析/Chap7Note.org::MK7][区间可加]]可得
...
故根据[[~/文档/note/数学分析/Chap7Note.org][绝对可积]]以及根据[[~/文档/note/数学分析/Chap8Note.org::MK9][反常积分绝对收敛:]]得
...
故根据[[~/文档/note/数学分析/Chap7Note.org][乘积可积]]有 $g(u)\phi(u)$ 在 $u\in[0,\delta]$ 上亦可积或绝对可积 则有
...
由于 $\frac{1}{u}$ 在 $[\eta,\delta]$ 上亦可积，则根据[[~/文档/note/数学分析/Chap7Note.org][乘积可积]] $\frac{\phi(u)-\phi(0^+)}{u}$ 可积
...
故根据[[~/文档/note/数学分析/Chap7Note.org][推论]]有在 $(0,\eta]$ 上的反常积分等于在 $[0,\eta]$ 上的常义积分
...
故根据[[~/文档/note/数学分析/Chap7Note.org][推论]]有在 $(0,\pi]$ 上的反常积分等于在 $[0,\pi]$ 上的常义积分
...
同理 $\frac{1}{\sin\left(\frac{u}{2}\right)}$ 可积，故根据[[~/文档/note/数学分析/Chap7Note.org][乘积可积]] $\frac{\phi(u,x)}{\sin\left(\frac{u}{2}\right)}$ 在 $u\in[a,\pi],0<a<\pi$ 可积或绝对可积
