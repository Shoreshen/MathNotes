...
故根据[[~/文档/note/数学分析/Chap11Note.org][Heine-Borel定理]]得 $D$ 为紧集

又根据[[~/文档/note/数学分析/Chap11Note.org][康托定理]]得 $f(\vec{x},\vec{y})$ 在区域 $D$ 上一致连续，定义积分区域 $S$ 的面积为 $V$
...
根据[[~/文档/note/数学分析/Chap13Note.org][性质]]中[线性]，[当 $f(\vec{x})=1$ 时]，[保序性]以及[绝对可积性]得
...
定义 $\vec{y}=(\vec{y}',y_k)$ ，故根据导数定义，[[~/文档/note/数学分析/Chap13Note.org][性质]]中[线性]，以及[[MK2][连续性定义推论]]
...
根据[[~/文档/note/数学分析/Chap7Note.org::MK8][保序]]及[[~/文档/note/数学分析/Chap7Note.org][绝对可积]]可得 $\left|\int_{A'}^{A''}f(x,y)dx\right|\leq\int_{A'}^{A''}|f(x,y)|dx\leq\int_{A'}^{A''}F(x)dx$
...
根据[[~/文档/note/数学分析/Chap7Note.org::MK8][保序]]及[[~/文档/note/数学分析/Chap7Note.org][绝对可积]]可得 $\left|\int_{b-\eta'}^{b-\eta''}f(x,y)dx\right|\leq\int_{b-\eta'}^{b-\eta''}|f(x,y)|dx\leq\int_{b-\eta'}^{b-\eta''}F(x)dx$
...
故根据[[~/文档/note/数学分析/Chap13Note.org::MK43][区域无限反常重积分计算]]以及[[~/文档/note/数学分析/Chap13Note.org][无界反常重积分计算]]
...
根据[[~/文档/note/数学分析/Chap13Note.org::MK28][引理1]]和[[~/文档/note/数学分析/Chap13Note.org][引理1]]
