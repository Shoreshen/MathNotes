...
2.  [简谐运动](#orgdc66bb4)
    1.  [定义](#org7d5527b)
    2.  [简谐运动的速度与加速度](#org3bb0f98)
    3.  [简谐运动的初始条件](#orgf0fde3d)
    4.  [旋转矢量表示法](#orgaa2e1ac)
        1.  [图像描述](#orga82ae6c)
    5.  [相图](#org1ffec99)
        1.  [相平面](#org5a4efa1)
        2.  [相点](#org2b05c62)
        3.  [相图](#org7b3201d)
    6.  [线性恢复力](#org3e15842)
    7.  [简谐运动动力学方程](#org6010270)
    8.  [单摆](#org011de9e)
        1.  [定义](#org8e04536)
        2.  [动力学方程1](#org91d4c46)
        3.  [动力学方程2](#org5686435)
        4.  [动力学方程近似](#orgfd809a6)
    9.  [简谐运动能量](#org6e1c1de)
        1.  [动能](#orgff0d4c3)
        2.  [势能](#orge9a9faf)
        3.  [简谐运动能量守恒](#orgbb3bd39)
3.  [简写运动合成](#org0a4ecfc)
    1.  [同方向](#orgd1fbb42)
        1.  [同方向同频率简谐运动合成](#org55d0b0e)
        2.  [同方向不同频率简写运动合成（拍）](#orgb4a8c5a)
    2.  [垂直](#org68c74ab)
...
## <a id="org6b47096"></a>简谐运动动力学方程

根据[质点运动-一般运动-牛顿三定律-动量定律](file:///e:/OneDrive/大学物理/Note/Note1.md)以及[线性恢复力](#org19ac4db)可得 \(F=ma\Rightarrow m\frac{d^2x}{dt^2}=-kx\)

整理上式得 \(\frac{d^2x}{dt^2}+\frac{k}{m}x=0\) 定义 \(\omega^2=\frac{k}{m}\) 则有 \(\frac{d^2x}{dt^2}+\omega^2x=0\) 此为 **简谐运动的动力学方程**

上式为二阶常系数齐次微分方程，根据[二阶微分方程-二阶线性齐次方程-二阶常系数齐次微分方程](file:///e:/OneDrive/大学物理/Note/DiffEq.md)
...
故有 \(x=A\left[\cos(\omega t)\cos(\phi)-\sin(\omega t)\sin(\phi)\right]=A\cos(\omega t+\phi)\) 该形式与简写运动[定义](#orgac4c440)一致
...
故[动力学方程1](#orge1b2380)可简化为 \(\frac{d^2\theta(t)}{dt^2}+\frac{g}{L}\theta=0\) 近似视为简谐运动
...
带入得 \(E_k=\frac{1}{2}mA^2\omega^2\sin^2(\omega t+\phi)\) 其中又根据[动力学方程](#org6b47096)有 \(\omega^2=\frac{k}{m}\)
...
势能可看做位移返回平衡位置时[线性恢复力](#org19ac4db)做的功，故当距离为 \(x\) 时积分 \(E_s=\int_x^0ktdt=\frac{1}{2}kx^2\) 为线性恢复力做的功
...
2.  证明合成后为简谐运动
    ...
    当 \(t=0\) 时 \(x=A_1\cos(\phi_1)+A_2\cos(\phi_2)\) 接下来利用[相图](#org7bb4f6c)求距离和 \(x\) 的值 
...
4.  多个同频率简谐运动叠加
    ...
    根据上述证明同理，结果任然为简谐运动。利用[相图](#org7bb4f6c)可得 \(\vec{A}=\sum_{i=1}^n\vec{A}_i\) 即为
